"""Make Workflow Run model not require workflow reference and store config

Revision ID: 45ec2d5032ab
Revises: f3cf1a4a6fc4
Create Date: 2025-04-10 08:21:41.369315
...
revision: str = '45ec2d5032ab'
down_revision: Union[str, None] = 'f3cf1a4a6fc4'
...
def upgrade() -> None:
    ...
    op.add_column('kw_wf_workflow_run', sa.Column('graph_schema', sa.JSON(), nullable=True))
    op.alter_column('kw_wf_workflow_run', 'workflow_id',
...
def downgrade() -> None:
    ...
    op.alter_column('kw_wf_workflow_run', 'workflow_id',
               existing_type=sa.UUID(),
               nullable=False)
    op.drop_column('kw_wf_workflow_run', 'graph_schema')
