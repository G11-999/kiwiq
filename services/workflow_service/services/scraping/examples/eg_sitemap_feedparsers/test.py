...
def parse_xml_sitemap(url: str, xml_content: str) -> List[str]:
    """
...
urls = parse_xml_sitemap("https://www.bbc.co.uk/sitemap.xml", xml_content="""<?xml version="1.0" encoding="UTF-8"?>
<!--
...
<sitemapindex xmlns="http://www.sitemaps.org/schemas/sitemap/0.9" >
   <sitemap><loc>https://www.bbc.co.uk/sport/sitemap.xml</loc></sitemap>
   <sitemap><loc>https://www.bbc.co.uk/news/localnews/locations/sitemap.xml</loc></sitemap>
   <sitemap><loc>https://www.bbc.co.uk/news/politics/eu-regions/vote2014_sitemap.xml</loc></sitemap>
   <sitemap><loc>https://www.bbc.co.uk/news/politics/councils/vote2014_sitemap.xml</loc></sitemap>
   <sitemap><loc>https://www.bbc.co.uk/news/events/vote2014/sitemap.xml</loc></sitemap>
   <sitemap><loc>https://www.bbc.co.uk/learningenglish/sitemap.xml</loc></sitemap>
</sitemapindex>
""")
# print(urls)
...
<!-- Last updated: 2025/07/17 04:36:31 -->
<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">
  <url>
    <loc>https://www.bbc.co.uk/learningenglish/home</loc>
    <lastmod>2025-07-16T12:21:13.107138Z</lastmod>
    <changefreq>monthly</changefreq>
    <priority>0.8</priority>
  </url>
  <url>
    <loc>https://www.bbc.co.uk/learningenglish/features/learning-english-from-the-news_2025/250716</loc>
    <lastmod>2025-07-16T11:12:28.932826Z</lastmod>
    <changefreq>monthly</changefreq>
    <priority>0.5</priority>
  </url>
  <url>
    <loc>https://www.bbc.co.uk/learningenglish/features/s5english_in_a_minute/250715</loc>
    <lastmod>2025-07-15T08:42:49.245316Z</lastmod>
    <changefreq>monthly</changefreq>
    <priority>0.5</priority>
  </url>
</urlset>
...
<head>
  ...
  <title>Requests and Responses &mdash; Scrapy 2.13.3 documentation</title>
      ...
      <link rel="stylesheet" type="text/css" href="../_static/custom.css?v=74c04d93" />
      <link rel="stylesheet" type="text/css" href="../_static/dark_mode_css/general.css?v=c0a7eb24" />
      <link rel="stylesheet" type="text/css" href="../_static/dark_mode_css/dark.css?v=70edf1c7" />

  
    <link rel="canonical" href="https://docs.scrapy.org/en/latest/topics/request-response.html" />
      <script src="../_static/jquery.js?v=5d32c60e"></script>
      <script src="../_static/_sphinx_javascript_frameworks_compat.js?v=2cd50e6c"></script>
      <script src="../_static/documentation_options.js?v=c2155eb7"></script>
...
<a href="https://scrapy.org">scrapy.org</a> / <a href="../index.html">docs</a>
...
<li class="toctree-l2"><a class="reference internal" href="#request-objects">Request objects</a><ul>
<li class="toctree-l3"><a class="reference internal" href="#scrapy.Request"><code class="docutils literal notranslate"><span class="pre">Request</span></code></a><ul>
<li class="toctree-l4"><a class="reference internal" href="#scrapy.Request.url"><code class="docutils literal notranslate"><span class="pre">Request.url</span></code></a></li>
<li class="toctree-l4"><a class="reference internal" href="#scrapy.Request.method"><code class="docutils literal notranslate"><span class="pre">Request.method</span></code></a></li>
<li class="toctree-l4"><a class="reference internal" href="#scrapy.Request.headers"><code class="docutils literal notranslate"><span class="pre">Request.headers</span></code></a></li>
<li class="toctree-l4"><a class="reference internal" href="#scrapy.Request.body"><code class="docutils literal notranslate"><span class="pre">Request.body</span></code></a></li>
<li class="toctree-l4"><a class="reference internal" href="#scrapy.Request.callback"><code class="docutils literal notranslate"><span class="pre">Request.callback</span></code></a></li>
<li class="toctree-l4"><a class="reference internal" href="#scrapy.Request.errback"><code class="docutils literal notranslate"><span class="pre">Request.errback</span></code></a></li>
<li class="toctree-l4"><a class="reference internal" href="#scrapy.Request.priority"><code class="docutils literal notranslate"><span class="pre">Request.priority</span></code></a></li>
<li class="toctree-l4"><a class="reference internal" href="#scrapy.Request.cb_kwargs"><code class="docutils literal notranslate"><span class="pre">Request.cb_kwargs</span></code></a></li>
<li class="toctree-l4"><a class="reference internal" href="#scrapy.Request.meta"><code class="docutils literal notranslate"><span class="pre">Request.meta</span></code></a></li>
<li class="toctree-l4"><a class="reference internal" href="#scrapy.Request.dont_filter"><code class="docutils literal notranslate"><span class="pre">Request.dont_filter</span></code></a></li>
<li class="toctree-l4"><a class="reference internal" href="#scrapy.Request.attributes"><code class="docutils literal notranslate"><span class="pre">Request.attributes</span></code></a></li>
<li class="toctree-l4"><a class="reference internal" href="#scrapy.Request.copy"><code class="docutils literal notranslate"><span class="pre">Request.copy()</span></code></a></li>
<li class="toctree-l4"><a class="reference internal" href="#scrapy.Request.replace"><code class="docutils literal notranslate"><span class="pre">Request.replace()</span></code></a></li>
<li class="toctree-l4"><a class="reference internal" href="#scrapy.Request.from_curl"><code class="docutils literal notranslate"><span class="pre">Request.from_curl()</span></code></a></li>
<li class="toctree-l4"><a class="reference internal" href="#scrapy.Request.to_dict"><code class="docutils literal notranslate"><span class="pre">Request.to_dict()</span></code></a></li>
</ul>
</li>
<li class="toctree-l3"><a class="reference internal" href="#other-functions-related-to-requests">Other functions related to requests</a><ul>
<li class="toctree-l4"><a class="reference internal" href="#scrapy.http.request.NO_CALLBACK"><code class="docutils literal notranslate"><span class="pre">NO_CALLBACK()</span></code></a></li>
<li class="toctree-l4"><a class="reference internal" href="#scrapy.utils.request.request_from_dict"><code class="docutils literal notranslate"><span class="pre">request_from_dict()</span></code></a></li>
</ul>
</li>
...
<li class="toctree-l3"><a class="reference internal" href="#using-errbacks-to-catch-exceptions-in-request-processing">Using errbacks to catch exceptions in request processing</a></li>
<li class="toctree-l3"><a class="reference internal" href="#accessing-additional-data-in-errback-functions">Accessing additional data in errback functions</a></li>
<li class="toctree-l3"><a class="reference internal" href="#request-fingerprints">Request fingerprints</a><ul>
<li class="toctree-l4"><a class="reference internal" href="#request-fingerprinter-class">REQUEST_FINGERPRINTER_CLASS</a></li>
<li class="toctree-l4"><a class="reference internal" href="#writing-your-own-request-fingerprinter">Writing your own request fingerprinter</a></li>
<li class="toctree-l4"><a class="reference internal" href="#request-fingerprint-restrictions">Request fingerprint restrictions</a></li>
</ul>
</li>
</ul>
</li>
...
<li class="toctree-l2"><a class="reference internal" href="#stopping-the-download-of-a-response">Stopping the download of a Response</a></li>
<li class="toctree-l2"><a class="reference internal" href="#request-subclasses">Request subclasses</a><ul>
<li class="toctree-l3"><a class="reference internal" href="#formrequest-objects">FormRequest objects</a><ul>
<li class="toctree-l4"><a class="reference internal" href="#scrapy.FormRequest"><code class="docutils literal notranslate"><span class="pre">scrapy.FormRequest</span></code></a></li>
</ul>
</li>
...
<li class="toctree-l3"><a class="reference internal" href="#jsonrequest">JsonRequest</a><ul>
<li class="toctree-l4"><a class="reference internal" href="#scrapy.http.JsonRequest"><code class="docutils literal notranslate"><span class="pre">JsonRequest</span></code></a></li>
</ul>
</li>
<li class="toctree-l3"><a class="reference internal" href="#jsonrequest-usage-example">JsonRequest usage example</a></li>
</ul>
</li>
<li class="toctree-l2"><a class="reference internal" href="#response-objects">Response objects</a><ul>
<li class="toctree-l3"><a class="reference internal" href="#scrapy.http.Response"><code class="docutils literal notranslate"><span class="pre">Response</span></code></a><ul>
<li class="toctree-l4"><a class="reference internal" href="#scrapy.http.Response.url"><code class="docutils literal notranslate"><span class="pre">Response.url</span></code></a></li>
<li class="toctree-l4"><a class="reference internal" href="#scrapy.http.Response.status"><code class="docutils literal notranslate"><span class="pre">Response.status</span></code></a></li>
<li class="toctree-l4"><a class="reference internal" href="#scrapy.http.Response.headers"><code class="docutils literal notranslate"><span class="pre">Response.headers</span></code></a></li>
<li class="toctree-l4"><a class="reference internal" href="#scrapy.http.Response.body"><code class="docutils literal notranslate"><span class="pre">Response.body</span></code></a></li>
<li class="toctree-l4"><a class="reference internal" href="#scrapy.http.Response.request"><code class="docutils literal notranslate"><span class="pre">Response.request</span></code></a></li>
<li class="toctree-l4"><a class="reference internal" href="#scrapy.http.Response.meta"><code class="docutils literal notranslate"><span class="pre">Response.meta</span></code></a></li>
<li class="toctree-l4"><a class="reference internal" href="#scrapy.http.Response.cb_kwargs"><code class="docutils literal notranslate"><span class="pre">Response.cb_kwargs</span></code></a></li>
<li class="toctree-l4"><a class="reference internal" href="#scrapy.http.Response.flags"><code class="docutils literal notranslate"><span class="pre">Response.flags</span></code></a></li>
<li class="toctree-l4"><a class="reference internal" href="#scrapy.http.Response.certificate"><code class="docutils literal notranslate"><span class="pre">Response.certificate</span></code></a></li>
<li class="toctree-l4"><a class="reference internal" href="#scrapy.http.Response.ip_address"><code class="docutils literal notranslate"><span class="pre">Response.ip_address</span></code></a></li>
<li class="toctree-l4"><a class="reference internal" href="#scrapy.http.Response.protocol"><code class="docutils literal notranslate"><span class="pre">Response.protocol</span></code></a></li>
<li class="toctree-l4"><a class="reference internal" href="#scrapy.http.Response.attributes"><code class="docutils literal notranslate"><span class="pre">Response.attributes</span></code></a></li>
<li class="toctree-l4"><a class="reference internal" href="#scrapy.http.Response.copy"><code class="docutils literal notranslate"><span class="pre">Response.copy()</span></code></a></li>
<li class="toctree-l4"><a class="reference internal" href="#scrapy.http.Response.replace"><code class="docutils literal notranslate"><span class="pre">Response.replace()</span></code></a></li>
<li class="toctree-l4"><a class="reference internal" href="#scrapy.http.Response.urljoin"><code class="docutils literal notranslate"><span class="pre">Response.urljoin()</span></code></a></li>
<li class="toctree-l4"><a class="reference internal" href="#scrapy.http.Response.follow"><code class="docutils literal notranslate"><span class="pre">Response.follow()</span></code></a></li>
<li class="toctree-l4"><a class="reference internal" href="#scrapy.http.Response.follow_all"><code class="docutils literal notranslate"><span class="pre">Response.follow_all()</span></code></a></li>
</ul>
</li>
</ul>
</li>
<li class="toctree-l2"><a class="reference internal" href="#response-subclasses">Response subclasses</a><ul>
<li class="toctree-l3"><a class="reference internal" href="#textresponse-objects">TextResponse objects</a><ul>
<li class="toctree-l4"><a class="reference internal" href="#scrapy.http.TextResponse"><code class="docutils literal notranslate"><span class="pre">TextResponse</span></code></a></li>
</ul>
</li>
<li class="toctree-l3"><a class="reference internal" href="#htmlresponse-objects">HtmlResponse objects</a><ul>
<li class="toctree-l4"><a class="reference internal" href="#scrapy.http.HtmlResponse"><code class="docutils literal notranslate"><span class="pre">HtmlResponse</span></code></a></li>
</ul>
</li>
<li class="toctree-l3"><a class="reference internal" href="#xmlresponse-objects">XmlResponse objects</a><ul>
<li class="toctree-l4"><a class="reference internal" href="#scrapy.http.XmlResponse"><code class="docutils literal notranslate"><span class="pre">XmlResponse</span></code></a></li>
</ul>
</li>
<li class="toctree-l3"><a class="reference internal" href="#jsonresponse-objects">JsonResponse objects</a><ul>
<li class="toctree-l4"><a class="reference internal" href="#scrapy.http.JsonResponse"><code class="docutils literal notranslate"><span class="pre">JsonResponse</span></code></a></li>
</ul>
</li>
</ul>
</li>
...
<li class="toctree-l1"><a class="reference internal" href="../versioning.html">Versioning and API stability</a></li>
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li class="breadcrumb-item active">Requests and Responses</li>
  ...
  <section id="module-scrapy.http">
<span id="requests-and-responses"></span><span id="topics-request-response"></span><h1>Requests and Responses<a class="headerlink" href="#module-scrapy.http" title="Link to this heading"></a></h1>
<p>Scrapy uses <a class="reference internal" href="#scrapy.Request" title="scrapy.Request"><code class="xref py py-class docutils literal notranslate"><span class="pre">Request</span></code></a> and <a class="reference internal" href="#scrapy.http.Response" title="scrapy.http.Response"><code class="xref py py-class docutils literal notranslate"><span class="pre">Response</span></code></a> objects for crawling web
sites.</p>
<p>Typically, <a class="reference internal" href="#scrapy.Request" title="scrapy.Request"><code class="xref py py-class docutils literal notranslate"><span class="pre">Request</span></code></a> objects are generated in the spiders and pass
...
<p>Both <a class="reference internal" href="#scrapy.Request" title="scrapy.Request"><code class="xref py py-class docutils literal notranslate"><span class="pre">Request</span></code></a> and <a class="reference internal" href="#scrapy.http.Response" title="scrapy.http.Response"><code class="xref py py-class docutils literal notranslate"><span class="pre">Response</span></code></a> classes have subclasses which add
...
<h2>Request objects<a class="headerlink" href="#request-objects" title="Link to this heading"></a></h2>
<dl class="py class">
<dt class="sig sig-object py" id="scrapy.Request">
<em class="property"><span class="pre">class</span><span class="w"> </span></em><span class="sig-prename descclassname"><span class="pre">scrapy.</span></span><span class="sig-name descname"><span class="pre">Request</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="o"><span class="pre">*</span></span><span class="n"><span class="pre">args</span></span><span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="n"><span class="pre">Any</span></span></em>, <em class="sig-param"><span class="o"><span class="pre">**</span></span><span class="n"><span class="pre">kwargs</span></span><span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="n"><span class="pre">Any</span></span></em><span class="sig-paren">)</span><a class="reference internal" href="../_modules/scrapy/http/request.html#Request"><span class="viewcode-link"><span class="pre">[source]</span></span></a><a class="headerlink" href="#scrapy.Request" title="Link to this definition"></a></dt>
...
<li><p><strong>callback</strong> (<em>Callable</em><em>[</em><em>Concatenate</em><em>[</em><a class="reference internal" href="#scrapy.http.Response" title="scrapy.http.Response"><em>Response</em></a><em>, </em><em>...</em><em>]</em><em>, </em><em>Any</em><em>] </em><em>| </em><em>None</em>) – <p>sets <a class="reference internal" href="#scrapy.Request.callback" title="scrapy.Request.callback"><code class="xref py py-attr docutils literal notranslate"><span class="pre">callback</span></code></a>, defaults to <code class="docutils literal notranslate"><span class="pre">None</span></code>.</p>
...
<li><p><strong>meta</strong> (<a class="reference external" href="https://docs.python.org/3/library/stdtypes.html#dict" title="(in Python v3.13)"><em>dict</em></a>) – the initial values for the <a class="reference internal" href="#scrapy.Request.meta" title="scrapy.Request.meta"><code class="xref py py-attr docutils literal notranslate"><span class="pre">Request.meta</span></code></a> attribute. If
...
<a class="hxr-hoverxref hxr-tooltip reference internal" href="downloader-middleware.html#cookies-mw"><span class="std std-ref">CookiesMiddleware</span></a>. If you need to set cookies for a request, use the
<code class="docutils literal notranslate"><span class="pre">cookies</span></code> argument. This is a known current limitation that is being
worked on.</p>
</div>
</p></li>
...
<a class="reference internal" href="#scrapy.Request.meta" title="scrapy.Request.meta"><code class="xref py py-attr docutils literal notranslate"><span class="pre">request.meta</span></code></a> causes custom cookies to be
ignored.</p>
<p>For more info see <a class="hxr-hoverxref hxr-tooltip reference internal" href="downloader-middleware.html#cookies-mw"><span class="std std-ref">CookiesMiddleware</span></a>.</p>
<div class="admonition caution">
<p class="admonition-title">Caution</p>
<p>Cookies set via the <code class="docutils literal notranslate"><span class="pre">Cookie</span></code> header are not considered by the
<a class="hxr-hoverxref hxr-tooltip reference internal" href="downloader-middleware.html#cookies-mw"><span class="std std-ref">CookiesMiddleware</span></a>. If you need to set cookies for a request, use the
<a class="reference internal" href="#scrapy.Request" title="scrapy.Request"><code class="xref py py-class docutils literal notranslate"><span class="pre">scrapy.Request.cookies</span></code></a> parameter. This is a known
current limitation that is being worked on.</p>
</div>
<div class="versionadded">
<p><span class="versionmodified added">Added in version 2.6.0: </span>Cookie values that are <a class="reference external" href="https://docs.python.org/3/library/functions.html#bool" title="(in Python v3.13)"><code class="xref py py-class docutils literal notranslate"><span class="pre">bool</span></code></a>, <a class="reference external" href="https://docs.python.org/3/library/functions.html#float" title="(in Python v3.13)"><code class="xref py py-class docutils literal notranslate"><span class="pre">float</span></code></a> or <a class="reference external" href="https://docs.python.org/3/library/functions.html#int" title="(in Python v3.13)"><code class="xref py py-class docutils literal notranslate"><span class="pre">int</span></code></a>
...
<li><p><strong>priority</strong> (<a class="reference external" href="https://docs.python.org/3/library/functions.html#int" title="(in Python v3.13)"><em>int</em></a>) – sets <a class="reference internal" href="#scrapy.Request.priority" title="scrapy.Request.priority"><code class="xref py py-attr docutils literal notranslate"><span class="pre">priority</span></code></a>, defaults to <code class="docutils literal notranslate"><span class="pre">0</span></code>.</p></li>
<li><p><strong>dont_filter</strong> (<a class="reference external" href="https://docs.python.org/3/library/functions.html#bool" title="(in Python v3.13)"><em>bool</em></a>) – sets <a class="reference internal" href="#scrapy.Request.dont_filter" title="scrapy.Request.dont_filter"><code class="xref py py-attr docutils literal notranslate"><span class="pre">dont_filter</span></code></a>, defaults to <code class="docutils literal notranslate"><span class="pre">False</span></code>.</p></li>
<li><p><strong>errback</strong> (<em>Callable</em><em>[</em><em>[</em><em>Failure</em><em>]</em><em>, </em><em>Any</em><em>] </em><em>| </em><em>None</em>) – <p>sets <a class="reference internal" href="#scrapy.Request.errback" title="scrapy.Request.errback"><code class="xref py py-attr docutils literal notranslate"><span class="pre">errback</span></code></a>, defaults to <code class="docutils literal notranslate"><span class="pre">None</span></code>.</p>
<div class="versionchanged">
<p><span class="versionmodified changed">Changed in version 2.0: </span>The <em>callback</em> parameter is no longer required when the <em>errback</em>
parameter is specified.</p>
</div>
...
<dt class="sig sig-object py" id="scrapy.Request.url">
<span class="sig-name descname"><span class="pre">url</span></span><a class="headerlink" href="#scrapy.Request.url" title="Link to this definition"></a></dt>
...
<a class="reference internal" href="#scrapy.Request.replace" title="scrapy.Request.replace"><code class="xref py py-meth docutils literal notranslate"><span class="pre">replace()</span></code></a>.</p>
</dd></dl>

<dl class="py attribute">
<dt class="sig sig-object py" id="scrapy.Request.method">
<span class="sig-name descname"><span class="pre">method</span></span><a class="headerlink" href="#scrapy.Request.method" title="Link to this definition"></a></dt>
...
<dl class="py attribute">
<dt class="sig sig-object py" id="scrapy.Request.headers">
<span class="sig-name descname"><span class="pre">headers</span></span><a class="headerlink" href="#scrapy.Request.headers" title="Link to this definition"></a></dt>
<dd><p>A dictionary-like (<code class="xref py py-class docutils literal notranslate"><span class="pre">scrapy.http.headers.Headers</span></code>) object which contains
the request headers.</p>
</dd></dl>

<dl class="py attribute">
<dt class="sig sig-object py" id="scrapy.Request.body">
<span class="sig-name descname"><span class="pre">body</span></span><a class="headerlink" href="#scrapy.Request.body" title="Link to this definition"></a></dt>
...
<dl class="py attribute">
<dt class="sig sig-object py" id="scrapy.Request.callback">
<span class="sig-name descname"><span class="pre">callback</span></span><em class="property"><span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">CallbackT</span><span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><a class="reference external" href="https://docs.python.org/3/library/constants.html#None" title="(in Python v3.13)"><span class="pre">None</span></a></em><a class="headerlink" href="#scrapy.Request.callback" title="Link to this definition"></a></dt>
<dd><p><a class="reference external" href="https://docs.python.org/3/library/collections.abc.html#collections.abc.Callable" title="(in Python v3.13)"><code class="xref py py-class docutils literal notranslate"><span class="pre">Callable</span></code></a> to parse the
<a class="reference internal" href="#scrapy.http.Response" title="scrapy.http.Response"><code class="xref py py-class docutils literal notranslate"><span class="pre">Response</span></code></a> to this request once received.</p>
<p>The callable must expect the response as its first parameter, and
support any additional keyword arguments set through
<a class="reference internal" href="#scrapy.Request.cb_kwargs" title="scrapy.Request.cb_kwargs"><code class="xref py py-attr docutils literal notranslate"><span class="pre">cb_kwargs</span></code></a>.</p>
<p>In addition to an arbitrary callable, the following values are also
supported:</p>
<ul class="simple">
<li><p><code class="docutils literal notranslate"><span class="pre">None</span></code> (default), which indicates that the
<a class="reference internal" href="spiders.html#scrapy.Spider.parse" title="scrapy.Spider.parse"><code class="xref py py-meth docutils literal notranslate"><span class="pre">parse()</span></code></a> method of the spider must be used.</p></li>
...
<p>If an unhandled exception is raised during request or response
processing, i.e. by a <a class="hxr-hoverxref hxr-tooltip reference internal" href="spider-middleware.html#topics-spider-middleware"><span class="std std-ref">spider middleware</span></a>, <a class="hxr-hoverxref hxr-tooltip reference internal" href="downloader-middleware.html#topics-downloader-middleware"><span class="std std-ref">downloader middleware</span></a> or download handler
(<a class="hxr-hoverxref hxr-tooltip reference internal" href="settings.html#std-setting-DOWNLOAD_HANDLERS"><code class="xref std std-setting docutils literal notranslate"><span class="pre">DOWNLOAD_HANDLERS</span></code></a>), <a class="reference internal" href="#scrapy.Request.errback" title="scrapy.Request.errback"><code class="xref py py-attr docutils literal notranslate"><span class="pre">errback</span></code></a> is called instead.</p>
<div class="admonition tip">
<p class="admonition-title">Tip</p>
<p><a class="reference internal" href="spider-middleware.html#scrapy.spidermiddlewares.httperror.HttpErrorMiddleware" title="scrapy.spidermiddlewares.httperror.HttpErrorMiddleware"><code class="xref py py-class docutils literal notranslate"><span class="pre">HttpErrorMiddleware</span></code></a>
raises exceptions for non-2xx responses by default, sending them
to the <a class="reference internal" href="#scrapy.Request.errback" title="scrapy.Request.errback"><code class="xref py py-attr docutils literal notranslate"><span class="pre">errback</span></code></a> instead.</p>
</div>
<div class="admonition seealso">
<p class="admonition-title">See also</p>
<p><a class="hxr-hoverxref hxr-tooltip reference internal" href="#topics-request-response-ref-request-callback-arguments"><span class="std std-ref">Passing additional data to callback functions</span></a></p>
</div>
</dd></dl>

<dl class="py attribute">
<dt class="sig sig-object py" id="scrapy.Request.errback">
<span class="sig-name descname"><span class="pre">errback</span></span><em class="property"><span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="pre">Callable</span><span class="p"><span class="pre">[</span></span><span class="p"><span class="pre">[</span></span><span class="pre">Failure</span><span class="p"><span class="pre">]</span></span><span class="p"><span class="pre">,</span></span><span class="w"> </span><span class="pre">Any</span><span class="p"><span class="pre">]</span></span><span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><a class="reference external" href="https://docs.python.org/3/library/constants.html#None" title="(in Python v3.13)"><span class="pre">None</span></a></em><a class="headerlink" href="#scrapy.Request.errback" title="Link to this definition"></a></dt>
<dd><p><a class="reference external" href="https://docs.python.org/3/library/collections.abc.html#collections.abc.Callable" title="(in Python v3.13)"><code class="xref py py-class docutils literal notranslate"><span class="pre">Callable</span></code></a> to handle exceptions raised
during request or response processing.</p>
<p>The callable must expect a <a class="reference external" href="https://docs.twisted.org/en/stable/api/twisted.python.failure.Failure.html" title="(in Twisted)"><code class="xref py py-exc docutils literal notranslate"><span class="pre">Failure</span></code></a> as
its first parameter.</p>
<div class="admonition seealso">
<p class="admonition-title">See also</p>
<p><a class="hxr-hoverxref hxr-tooltip reference internal" href="#topics-request-response-ref-errbacks"><span class="std std-ref">Using errbacks to catch exceptions in request processing</span></a></p>
</div>
</dd></dl>

<dl class="py attribute">
<dt class="sig sig-object py" id="scrapy.Request.priority">
<span class="sig-name descname"><span class="pre">priority</span></span><em class="property"><span class="p"><span class="pre">:</span></span><span class="w"> </span><a class="reference external" href="https://docs.python.org/3/library/functions.html#int" title="(in Python v3.13)"><span class="pre">int</span></a></em><a class="headerlink" href="#scrapy.Request.priority" title="Link to this definition"></a></dt>
<dd><p>Default: <code class="docutils literal notranslate"><span class="pre">0</span></code></p>
<p>Value that the <a class="hxr-hoverxref hxr-tooltip reference internal" href="scheduler.html#topics-scheduler"><span class="std std-ref">scheduler</span></a> may use for
request prioritization.</p>
<p>Built-in schedulers prioritize requests with a higher priority
value.</p>
<p>Negative values are allowed.</p>
</dd></dl>

<dl class="py attribute">
<dt class="sig sig-object py" id="scrapy.Request.cb_kwargs">
<span class="sig-name descname"><span class="pre">cb_kwargs</span></span><a class="headerlink" href="#scrapy.Request.cb_kwargs" title="Link to this definition"></a></dt>
...
<a class="reference internal" href="#scrapy.http.Response" title="scrapy.http.Response"><code class="xref py py-class docutils literal notranslate"><span class="pre">Response</span></code></a> object as argument.</p>
...
<dl class="py attribute">
<dt class="sig sig-object py" id="scrapy.Request.meta">
<span class="sig-name descname"><span class="pre">meta</span></span><em class="property"><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">{}</span></em><a class="headerlink" href="#scrapy.Request.meta" title="Link to this definition"></a></dt>
<dd><blockquote>
...
<a class="reference internal" href="#scrapy.Request.cb_kwargs" title="scrapy.Request.cb_kwargs"><code class="xref py py-attr docutils literal notranslate"><span class="pre">cb_kwargs</span></code></a> instead. However, request metadata may be the right
...
<a class="reference internal" href="downloader-middleware.html#scrapy.downloadermiddlewares.retry.RetryMiddleware" title="scrapy.downloadermiddlewares.retry.RetryMiddleware"><code class="xref py py-class docutils literal notranslate"><span class="pre">RetryMiddleware</span></code></a> will never
...
For example,
<a class="reference internal" href="downloader-middleware.html#scrapy.downloadermiddlewares.retry.RetryMiddleware" title="scrapy.downloadermiddlewares.retry.RetryMiddleware"><code class="xref py py-class docutils literal notranslate"><span class="pre">RetryMiddleware</span></code></a> uses the
...
case when returning a request from a <a class="hxr-hoverxref hxr-tooltip reference internal" href="downloader-middleware.html#topics-downloader-middleware"><span class="std std-ref">downloader middleware</span></a> method.</p>
<p>Also mind that the <a class="reference internal" href="#scrapy.Request.copy" title="scrapy.Request.copy"><code class="xref py py-meth docutils literal notranslate"><span class="pre">copy()</span></code></a> and <a class="reference internal" href="#scrapy.Request.replace" title="scrapy.Request.replace"><code class="xref py py-meth docutils literal notranslate"><span class="pre">replace()</span></code></a> request methods
...
<dl class="py attribute">
<dt class="sig sig-object py" id="scrapy.Request.dont_filter">
<span class="sig-name descname"><span class="pre">dont_filter</span></span><em class="property"><span class="p"><span class="pre">:</span></span><span class="w"> </span><a class="reference external" href="https://docs.python.org/3/library/functions.html#bool" title="(in Python v3.13)"><span class="pre">bool</span></a></em><a class="headerlink" href="#scrapy.Request.dont_filter" title="Link to this definition"></a></dt>
<dd><p>Whether this request may be filtered out by <a class="hxr-hoverxref hxr-tooltip reference internal" href="components.html#topics-components"><span class="std std-ref">components</span></a> that support filtering out requests (<code class="docutils literal notranslate"><span class="pre">False</span></code>,
default), or those components should not filter out this request
(<code class="docutils literal notranslate"><span class="pre">True</span></code>).</p>
<p>This attribute is commonly set to <code class="docutils literal notranslate"><span class="pre">True</span></code> to prevent duplicate
requests from being filtered out.</p>
<p>When defining the start URLs of a spider through
<a class="reference internal" href="spiders.html#scrapy.Spider.start_urls" title="scrapy.Spider.start_urls"><code class="xref py py-attr docutils literal notranslate"><span class="pre">start_urls</span></code></a>, this attribute is enabled by
default. See <a class="reference internal" href="spiders.html#scrapy.Spider.start" title="scrapy.Spider.start"><code class="xref py py-meth docutils literal notranslate"><span class="pre">start()</span></code></a>.</p>
</dd></dl>

<dl class="py attribute">
<dt class="sig sig-object py" id="scrapy.Request.attributes">
<span class="sig-name descname"><span class="pre">attributes</span></span><em class="property"><span class="p"><span class="pre">:</span></span><span class="w"> </span><a class="reference external" href="https://docs.python.org/3/library/stdtypes.html#tuple" title="(in Python v3.13)"><span class="pre">tuple</span></a><span class="p"><span class="pre">[</span></span><a class="reference external" href="https://docs.python.org/3/library/stdtypes.html#str" title="(in Python v3.13)"><span class="pre">str</span></a><span class="p"><span class="pre">,</span></span><span class="w"> </span><span class="p"><span class="pre">...</span></span><span class="p"><span class="pre">]</span></span></em><em class="property"><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">('url',</span> <span class="pre">'callback',</span> <span class="pre">'method',</span> <span class="pre">'headers',</span> <span class="pre">'body',</span> <span class="pre">'cookies',</span> <span class="pre">'meta',</span> <span class="pre">'encoding',</span> <span class="pre">'priority',</span> <span class="pre">'dont_filter',</span> <span class="pre">'errback',</span> <span class="pre">'flags',</span> <span class="pre">'cb_kwargs')</span></em><a class="headerlink" href="#scrapy.Request.attributes" title="Link to this definition"></a></dt>
...
<p>Currently used by <a class="reference internal" href="#scrapy.Request.replace" title="scrapy.Request.replace"><code class="xref py py-meth docutils literal notranslate"><span class="pre">Request.replace()</span></code></a>, <a class="reference internal" href="#scrapy.Request.to_dict" title="scrapy.Request.to_dict"><code class="xref py py-meth docutils literal notranslate"><span class="pre">Request.to_dict()</span></code></a> and
...
<dl class="py method">
<dt class="sig sig-object py" id="scrapy.Request.copy">
<span class="sig-name descname"><span class="pre">copy</span></span><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="reference internal" href="../_modules/scrapy/http/request.html#Request.copy"><span class="viewcode-link"><span class="pre">[source]</span></span></a><a class="headerlink" href="#scrapy.Request.copy" title="Link to this definition"></a></dt>
...
arguments as the <a class="reference internal" href="#scrapy.Request" title="scrapy.Request"><code class="xref py py-class docutils literal notranslate"><span class="pre">Request</span></code></a> class, taking preference and
...
<div class="admonition caution">
<p class="admonition-title">Caution</p>
<p>Using <a class="reference internal" href="#scrapy.Request.from_curl" title="scrapy.Request.from_curl"><code class="xref py py-meth docutils literal notranslate"><span class="pre">from_curl()</span></code></a> from <a class="reference internal" href="#scrapy.Request" title="scrapy.Request"><code class="xref py py-class docutils literal notranslate"><span class="pre">Request</span></code></a>
...
<a class="hxr-hoverxref hxr-tooltip reference internal" href="downloader-middleware.html#topics-downloader-middleware"><span class="std std-ref">downloader middlewares</span></a>
and
<a class="hxr-hoverxref hxr-tooltip reference internal" href="spider-middleware.html#topics-spider-middleware"><span class="std std-ref">spider middlewares</span></a>
enabled, such as
...
<a class="reference internal" href="downloader-middleware.html#scrapy.downloadermiddlewares.useragent.UserAgentMiddleware" title="scrapy.downloadermiddlewares.useragent.UserAgentMiddleware"><code class="xref py py-class docutils literal notranslate"><span class="pre">UserAgentMiddleware</span></code></a>,
or
<a class="reference internal" href="downloader-middleware.html#scrapy.downloadermiddlewares.httpcompression.HttpCompressionMiddleware" title="scrapy.downloadermiddlewares.httpcompression.HttpCompressionMiddleware"><code class="xref py py-class docutils literal notranslate"><span class="pre">HttpCompressionMiddleware</span></code></a>,
may modify the <a class="reference internal" href="#scrapy.Request" title="scrapy.Request"><code class="xref py py-class docutils literal notranslate"><span class="pre">Request</span></code></a> object.</p>
</div>
...
<dl class="py method">
<dt class="sig sig-object py" id="scrapy.Request.to_dict">
<span class="sig-name descname"><span class="pre">to_dict</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="o"><span class="pre">*</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">spider</span></span><span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="n"><a class="reference internal" href="spiders.html#scrapy.spiders.Spider" title="scrapy.spiders.Spider"><span class="pre">Spider</span></a><span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><a class="reference external" href="https://docs.python.org/3/library/constants.html#None" title="(in Python v3.13)"><span class="pre">None</span></a></span><span class="w"> </span><span class="o"><span class="pre">=</span></span><span class="w"> </span><span class="default_value"><span class="pre">None</span></span></em><span class="sig-paren">)</span> <span class="sig-return"><span class="sig-return-icon">&#x2192;</span> <span class="sig-return-typehint"><a class="reference external" href="https://docs.python.org/3/library/stdtypes.html#dict" title="(in Python v3.13)"><span class="pre">dict</span></a><span class="p"><span class="pre">[</span></span><a class="reference external" href="https://docs.python.org/3/library/stdtypes.html#str" title="(in Python v3.13)"><span class="pre">str</span></a><span class="p"><span class="pre">,</span></span><span class="w"> </span><a class="reference external" href="https://docs.python.org/3/library/typing.html#typing.Any" title="(in Python v3.13)"><span class="pre">Any</span></a><span class="p"><span class="pre">]</span></span></span></span><a class="reference internal" href="../_modules/scrapy/http/request.html#Request.to_dict"><span class="viewcode-link"><span class="pre">[source]</span></span></a><a class="headerlink" href="#scrapy.Request.to_dict" title="Link to this definition"></a></dt>
<dd><p>Return a dictionary containing the Request’s data.</p>
<p>Use <a class="reference internal" href="#scrapy.utils.request.request_from_dict" title="scrapy.utils.request.request_from_dict"><code class="xref py py-func docutils literal notranslate"><span class="pre">request_from_dict()</span></code></a> to convert back into a <a class="reference internal" href="#scrapy.Request" title="scrapy.Request"><code class="xref py py-class docutils literal notranslate"><span class="pre">Request</span></code></a> object.</p>
...
<p>This value should be used by <a class="hxr-hoverxref hxr-tooltip reference internal" href="components.html#topics-components"><span class="std std-ref">components</span></a> that
...
intended for the <a class="reference internal" href="spiders.html#scrapy.Spider.parse" title="scrapy.Spider.parse"><code class="xref py py-meth docutils literal notranslate"><span class="pre">parse()</span></code></a> callback.</p>
</dd></dl>

<dl class="py function">
<dt class="sig sig-object py" id="scrapy.utils.request.request_from_dict">
<span class="sig-prename descclassname"><span class="pre">scrapy.utils.request.</span></span><span class="sig-name descname"><span class="pre">request_from_dict</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">d</span></span><span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="n"><a class="reference external" href="https://docs.python.org/3/library/stdtypes.html#dict" title="(in Python v3.13)"><span class="pre">dict</span></a><span class="p"><span class="pre">[</span></span><a class="reference external" href="https://docs.python.org/3/library/stdtypes.html#str" title="(in Python v3.13)"><span class="pre">str</span></a><span class="p"><span class="pre">,</span></span><span class="w"> </span><a class="reference external" href="https://docs.python.org/3/library/typing.html#typing.Any" title="(in Python v3.13)"><span class="pre">Any</span></a><span class="p"><span class="pre">]</span></span></span></em>, <em class="sig-param"><span class="o"><span class="pre">*</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">spider</span></span><span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="n"><a class="reference internal" href="spiders.html#scrapy.spiders.Spider" title="scrapy.spiders.Spider"><span class="pre">Spider</span></a><span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><a class="reference external" href="https://docs.python.org/3/library/constants.html#None" title="(in Python v3.13)"><span class="pre">None</span></a></span><span class="w"> </span><span class="o"><span class="pre">=</span></span><span class="w"> </span><span class="default_value"><span class="pre">None</span></span></em><span class="sig-paren">)</span> <span class="sig-return"><span class="sig-return-icon">&#x2192;</span> <span class="sig-return-typehint"><a class="reference internal" href="#scrapy.Request" title="scrapy.http.request.Request"><span class="pre">Request</span></a></span></span><a class="reference internal" href="../_modules/scrapy/utils/request.html#request_from_dict"><span class="viewcode-link"><span class="pre">[source]</span></span></a><a class="headerlink" href="#scrapy.utils.request.request_from_dict" title="Link to this definition"></a></dt>
<dd><p>Create a <a class="reference internal" href="#scrapy.Request" title="scrapy.Request"><code class="xref py py-class docutils literal notranslate"><span class="pre">Request</span></code></a> object from a dict.</p>
...
<span id="topics-request-response-ref-request-callback-arguments"></span><h3>Passing additional data to callback functions<a class="headerlink" href="#passing-additional-data-to-callback-functions" title="Link to this heading"></a></h3>
...
<p>Example:</p>
<div class="highlight-python notranslate"><div class="highlight"><pre><span></span><span class="k">def</span><span class="w"> </span><span class="nf">parse_page1</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">response</span><span class="p">):</span>
...
<span class="k">def</span><span class="w"> </span><span class="nf">parse_page2</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">response</span><span class="p">):</span>
...
<a class="reference internal" href="#scrapy.Request.cb_kwargs" title="scrapy.Request.cb_kwargs"><code class="xref py py-attr docutils literal notranslate"><span class="pre">Request.cb_kwargs</span></code></a> attribute:</p>
...
<span class="k">def</span><span class="w"> </span><span class="nf">parse_page2</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">response</span><span class="p">,</span> <span class="n">main_url</span><span class="p">,</span> <span class="n">foo</span><span class="p">):</span>
...
<div class="admonition caution">
<p class="admonition-title">Caution</p>
<p><a class="reference internal" href="#scrapy.Request.cb_kwargs" title="scrapy.Request.cb_kwargs"><code class="xref py py-attr docutils literal notranslate"><span class="pre">Request.cb_kwargs</span></code></a> was introduced in version <code class="docutils literal notranslate"><span class="pre">1.7</span></code>.
Prior to that, using <a class="reference internal" href="#scrapy.Request.meta" title="scrapy.Request.meta"><code class="xref py py-attr docutils literal notranslate"><span class="pre">Request.meta</span></code></a> was recommended for passing
information around callbacks. After <code class="docutils literal notranslate"><span class="pre">1.7</span></code>, <a class="reference internal" href="#scrapy.Request.cb_kwargs" title="scrapy.Request.cb_kwargs"><code class="xref py py-attr docutils literal notranslate"><span class="pre">Request.cb_kwargs</span></code></a>
became the preferred way for handling user information, leaving <a class="reference internal" href="#scrapy.Request.meta" title="scrapy.Request.meta"><code class="xref py py-attr docutils literal notranslate"><span class="pre">Request.meta</span></code></a>
...
<span id="topics-request-response-ref-errbacks"></span><h3>Using errbacks to catch exceptions in request processing<a class="headerlink" href="#using-errbacks-to-catch-exceptions-in-request-processing" title="Link to this heading"></a></h3>
...
errors if needed:</p>
<div class="highlight-python notranslate"><div class="highlight"><pre><span></span><span class="kn">import</span><span class="w"> </span><span class="nn">scrapy</span>

<span class="kn">from</span><span class="w"> </span><span class="nn">scrapy.spidermiddlewares.httperror</span><span class="w"> </span><span class="kn">import</span> <span class="n">HttpError</span>
<span class="kn">from</span><span class="w"> </span><span class="nn">twisted.internet.error</span><span class="w"> </span><span class="kn">import</span> <span class="n">DNSLookupError</span>
<span class="kn">from</span><span class="w"> </span><span class="nn">twisted.internet.error</span><span class="w"> </span><span class="kn">import</span> <span class="ne">TimeoutError</span><span class="p">,</span> <span class="n">TCPTimedOutError</span>


<span class="k">class</span><span class="w"> </span><span class="nc">ErrbackSpider</span><span class="p">(</span><span class="n">scrapy</span><span class="o">.</span><span class="n">Spider</span><span class="p">):</span>
    ...
    <span class="k">def</span><span class="w"> </span><span class="nf">parse_httpbin</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">response</span><span class="p">):</span>
    ...
    <span class="k">def</span><span class="w"> </span><span class="nf">errback_httpbin</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">failure</span><span class="p">):</span>
...
<span id="errback-cb-kwargs"></span><h3>Accessing additional data in errback functions<a class="headerlink" href="#accessing-additional-data-in-errback-functions" title="Link to this heading"></a></h3>
...
<span class="k">def</span><span class="w"> </span><span class="nf">parse_page2</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">response</span><span class="p">,</span> <span class="n">main_url</span><span class="p">):</span>
    <span class="k">pass</span>


<span class="k">def</span><span class="w"> </span><span class="nf">errback_page2</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">failure</span><span class="p">):</span>
    <span class="k">yield</span> <span class="nb">dict</span><span class="p">(</span>
...
<span id="id1"></span><h3>Request fingerprints<a class="headerlink" href="#request-fingerprints" title="Link to this heading"></a></h3>
<p>There are some aspects of scraping, such as filtering out duplicate requests
(see <a class="hxr-hoverxref hxr-tooltip reference internal" href="settings.html#std-setting-DUPEFILTER_CLASS"><code class="xref std std-setting docutils literal notranslate"><span class="pre">DUPEFILTER_CLASS</span></code></a>) or caching responses (see
<a class="hxr-hoverxref hxr-tooltip reference internal" href="downloader-middleware.html#std-setting-HTTPCACHE_POLICY"><code class="xref std std-setting docutils literal notranslate"><span class="pre">HTTPCACHE_POLICY</span></code></a>), where you need the ability to generate a short,
unique identifier from a <a class="reference internal" href="#scrapy.Request" title="scrapy.Request"><code class="xref py py-class docutils literal notranslate"><span class="pre">Request</span></code></a> object: a request
fingerprint.</p>
...
<span id="std-setting-REQUEST_FINGERPRINTER_CLASS"></span><h4>REQUEST_FINGERPRINTER_CLASS<a class="headerlink" href="#request-fingerprinter-class" title="Link to this heading"></a></h4>
<div class="versionadded">
...
<em class="property"><span class="pre">class</span><span class="w"> </span></em><span class="sig-prename descclassname"><span class="pre">scrapy.utils.request.</span></span><span class="sig-name descname"><span class="pre">RequestFingerprinter</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">crawler</span></span><span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="n"><a class="reference internal" href="api.html#scrapy.crawler.Crawler" title="scrapy.crawler.Crawler"><span class="pre">Crawler</span></a><span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><a class="reference external" href="https://docs.python.org/3/library/constants.html#None" title="(in Python v3.13)"><span class="pre">None</span></a></span><span class="w"> </span><span class="o"><span class="pre">=</span></span><span class="w"> </span><span class="default_value"><span class="pre">None</span></span></em><span class="sig-paren">)</span><a class="reference internal" href="../_modules/scrapy/utils/request.html#RequestFingerprinter"><span class="viewcode-link"><span class="pre">[source]</span></span></a><a class="headerlink" href="#scrapy.utils.request.RequestFingerprinter" title="Link to this definition"></a></dt>
<dd><p>Default fingerprinter.</p>
<p>It takes into account a canonical version
(<a class="reference external" href="https://w3lib.readthedocs.io/en/latest/w3lib.html#w3lib.url.canonicalize_url" title="(in w3lib v2.3)"><code class="xref py py-func docutils literal notranslate"><span class="pre">w3lib.url.canonicalize_url()</span></code></a>) of <a class="reference internal" href="#scrapy.Request.url" title="scrapy.Request.url"><code class="xref py py-attr docutils literal notranslate"><span class="pre">request.url</span></code></a> and the values of <a class="reference internal" href="#scrapy.Request.method" title="scrapy.Request.method"><code class="xref py py-attr docutils literal notranslate"><span class="pre">request.method</span></code></a> and <a class="reference internal" href="#scrapy.Request.body" title="scrapy.Request.body"><code class="xref py py-attr docutils literal notranslate"><span class="pre">request.body</span></code></a>. It then generates an <a class="reference external" href="https://en.wikipedia.org/wiki/SHA-1">SHA1</a> hash.</p>
</dd></dl>

</section>
<section id="writing-your-own-request-fingerprinter">
<span id="custom-request-fingerprinter"></span><h4>Writing your own request fingerprinter<a class="headerlink" href="#writing-your-own-request-fingerprinter" title="Link to this heading"></a></h4>
<p>A request fingerprinter is a <a class="hxr-hoverxref hxr-tooltip reference internal" href="components.html#topics-components"><span class="std std-ref">component</span></a> that must
implement the following method:</p>
<dl class="py method">
<dt class="sig sig-object py" id="fingerprint">
<span class="sig-name descname"><span class="pre">fingerprint</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">self</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">request</span></span><span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="n"><a class="reference internal" href="#scrapy.Request" title="scrapy.Request"><span class="pre">scrapy.Request</span></a></span></em><span class="sig-paren">)</span><a class="headerlink" href="#fingerprint" title="Link to this definition"></a></dt>
...
<span class="sig-prename descclassname"><span class="pre">scrapy.utils.request.</span></span><span class="sig-name descname"><span class="pre">fingerprint</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">request</span></span><span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="n"><a class="reference internal" href="#scrapy.Request" title="scrapy.Request"><span class="pre">Request</span></a></span></em>, <em class="sig-param"><span class="o"><span class="pre">*</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">include_headers</span></span><span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="n"><span class="pre">Iterable</span><span class="p"><span class="pre">[</span></span><a class="reference external" href="https://docs.python.org/3/library/stdtypes.html#bytes" title="(in Python v3.13)"><span class="pre">bytes</span></a><span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><a class="reference external" href="https://docs.python.org/3/library/stdtypes.html#str" title="(in Python v3.13)"><span class="pre">str</span></a><span class="p"><span class="pre">]</span></span><span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><a class="reference external" href="https://docs.python.org/3/library/constants.html#None" title="(in Python v3.13)"><span class="pre">None</span></a></span><span class="w"> </span><span class="o"><span class="pre">=</span></span><span class="w"> </span><span class="default_value"><span class="pre">None</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">keep_fragments</span></span><span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="n"><a class="reference external" href="https://docs.python.org/3/library/functions.html#bool" title="(in Python v3.13)"><span class="pre">bool</span></a></span><span class="w"> </span><span class="o"><span class="pre">=</span></span><span class="w"> </span><span class="default_value"><span class="pre">False</span></span></em><span class="sig-paren">)</span> <span class="sig-return"><span class="sig-return-icon">&#x2192;</span> <span class="sig-return-typehint"><a class="reference external" href="https://docs.python.org/3/library/stdtypes.html#bytes" title="(in Python v3.13)"><span class="pre">bytes</span></a></span></span><a class="reference internal" href="../_modules/scrapy/utils/request.html#fingerprint"><span class="viewcode-link"><span class="pre">[source]</span></span></a><a class="headerlink" href="#scrapy.utils.request.fingerprint" title="Link to this definition"></a></dt>
...
<span class="kn">from</span><span class="w"> </span><span class="nn">scrapy.utils.request</span><span class="w"> </span><span class="kn">import</span> <span class="n">fingerprint</span>


<span class="k">class</span><span class="w"> </span><span class="nc">RequestFingerprinter</span><span class="p">:</span>
    <span class="k">def</span><span class="w"> </span><span class="nf">fingerprint</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">request</span><span class="p">):</span>
...
<div class="highlight-python notranslate"><div class="highlight"><pre><span></span><span class="kn">from</span><span class="w"> </span><span class="nn">hashlib</span><span class="w"> </span><span class="kn">import</span> <span class="n">sha1</span>
...
<span class="kn">from</span><span class="w"> </span><span class="nn">scrapy.utils.python</span><span class="w"> </span><span class="kn">import</span> <span class="n">to_bytes</span>
...
that reads fingerprints from <a class="reference internal" href="#scrapy.Request.meta" title="scrapy.Request.meta"><code class="xref py py-attr docutils literal notranslate"><span class="pre">request.meta</span></code></a>
...
<div class="highlight-python notranslate"><div class="highlight"><pre><span></span><span class="kn">from</span><span class="w"> </span><span class="nn">scrapy.utils.request</span><span class="w"> </span><span class="kn">import</span> <span class="n">fingerprint</span>
...
<p>If you need to reproduce the same fingerprinting algorithm as Scrapy 2.6, use
the following request fingerprinter:</p>
<div class="highlight-python notranslate"><div class="highlight"><pre><span></span><span class="kn">from</span><span class="w"> </span><span class="nn">hashlib</span><span class="w"> </span><span class="kn">import</span> <span class="n">sha1</span>
<span class="kn">from</span><span class="w"> </span><span class="nn">weakref</span><span class="w"> </span><span class="kn">import</span> <span class="n">WeakKeyDictionary</span>

<span class="kn">from</span><span class="w"> </span><span class="nn">scrapy.utils.python</span><span class="w"> </span><span class="kn">import</span> <span class="n">to_bytes</span>
<span class="kn">from</span><span class="w"> </span><span class="nn">w3lib.url</span><span class="w"> </span><span class="kn">import</span> <span class="n">canonicalize_url</span>
...
<span id="id2"></span><h4>Request fingerprint restrictions<a class="headerlink" href="#request-fingerprint-restrictions" title="Link to this heading"></a></h4>
...
<ul>
<li><p><a class="reference internal" href="downloader-middleware.html#scrapy.extensions.httpcache.FilesystemCacheStorage" title="scrapy.extensions.httpcache.FilesystemCacheStorage"><code class="xref py py-class docutils literal notranslate"><span class="pre">scrapy.extensions.httpcache.FilesystemCacheStorage</span></code></a> (default
value of <a class="hxr-hoverxref hxr-tooltip reference internal" href="downloader-middleware.html#std-setting-HTTPCACHE_STORAGE"><code class="xref std std-setting docutils literal notranslate"><span class="pre">HTTPCACHE_STORAGE</span></code></a>)</p>
<p>Request fingerprints must be at least 1 byte long.</p>
<p>Path and filename length limits of the file system of
<a class="hxr-hoverxref hxr-tooltip reference internal" href="downloader-middleware.html#std-setting-HTTPCACHE_DIR"><code class="xref std std-setting docutils literal notranslate"><span class="pre">HTTPCACHE_DIR</span></code></a> also apply. Inside <a class="hxr-hoverxref hxr-tooltip reference internal" href="downloader-middleware.html#std-setting-HTTPCACHE_DIR"><code class="xref std std-setting docutils literal notranslate"><span class="pre">HTTPCACHE_DIR</span></code></a>,
the following directory structure is created:</p>
<ul class="simple">
<li><p><a class="reference internal" href="spiders.html#scrapy.Spider.name" title="scrapy.Spider.name"><code class="xref py py-attr docutils literal notranslate"><span class="pre">Spider.name</span></code></a></p>
<ul>
...
<a class="hxr-hoverxref hxr-tooltip reference internal" href="downloader-middleware.html#std-setting-HTTPCACHE_DIR"><code class="xref std std-setting docutils literal notranslate"><span class="pre">HTTPCACHE_DIR</span></code></a> is <code class="docutils literal notranslate"><span class="pre">'/home/user/project/.scrapy/httpcache'</span></code>,
...
<li><p><a class="reference internal" href="downloader-middleware.html#scrapy.extensions.httpcache.DbmCacheStorage" title="scrapy.extensions.httpcache.DbmCacheStorage"><code class="xref py py-class docutils literal notranslate"><span class="pre">scrapy.extensions.httpcache.DbmCacheStorage</span></code></a></p>
...
<span id="topics-request-meta"></span><h2>Request.meta special keys<a class="headerlink" href="#request-meta-special-keys" title="Link to this heading"></a></h2>
<p>The <a class="reference internal" href="#scrapy.Request.meta" title="scrapy.Request.meta"><code class="xref py py-attr docutils literal notranslate"><span class="pre">Request.meta</span></code></a> attribute can contain any arbitrary data, but there
are some special keys recognized by Scrapy and its built-in extensions.</p>
<p>Those are:</p>
<ul class="simple">
<li><p><a class="hxr-hoverxref hxr-tooltip reference internal" href="downloader-middleware.html#std-reqmeta-allow_offsite"><code class="xref std std-reqmeta docutils literal notranslate"><span class="pre">allow_offsite</span></code></a></p></li>
<li><p><a class="hxr-hoverxref hxr-tooltip reference internal" href="autothrottle.html#std-reqmeta-autothrottle_dont_adjust_delay"><code class="xref std std-reqmeta docutils literal notranslate"><span class="pre">autothrottle_dont_adjust_delay</span></code></a></p></li>
...
<li><p><a class="hxr-hoverxref hxr-tooltip reference internal" href="downloader-middleware.html#std-reqmeta-cookiejar"><code class="xref std std-reqmeta docutils literal notranslate"><span class="pre">cookiejar</span></code></a></p></li>
<li><p><a class="hxr-hoverxref hxr-tooltip reference internal" href="downloader-middleware.html#std-reqmeta-dont_cache"><code class="xref std std-reqmeta docutils literal notranslate"><span class="pre">dont_cache</span></code></a></p></li>
...
<li><p><a class="hxr-hoverxref hxr-tooltip reference internal" href="downloader-middleware.html#std-reqmeta-dont_obey_robotstxt"><code class="xref std std-reqmeta docutils literal notranslate"><span class="pre">dont_obey_robotstxt</span></code></a></p></li>
<li><p><a class="hxr-hoverxref hxr-tooltip reference internal" href="downloader-middleware.html#std-reqmeta-dont_redirect"><code class="xref std std-reqmeta docutils literal notranslate"><span class="pre">dont_redirect</span></code></a></p></li>
<li><p><a class="hxr-hoverxref hxr-tooltip reference internal" href="downloader-middleware.html#std-reqmeta-dont_retry"><code class="xref std std-reqmeta docutils literal notranslate"><span class="pre">dont_retry</span></code></a></p></li>
...
<li><p><a class="hxr-hoverxref hxr-tooltip reference internal" href="settings.html#std-reqmeta-download_maxsize"><code class="xref std std-reqmeta docutils literal notranslate"><span class="pre">download_maxsize</span></code></a></p></li>
<li><p><a class="hxr-hoverxref hxr-tooltip reference internal" href="settings.html#std-reqmeta-download_warnsize"><code class="xref std std-reqmeta docutils literal notranslate"><span class="pre">download_warnsize</span></code></a></p></li>
...
<li><p><code class="docutils literal notranslate"><span class="pre">ftp_password</span></code> (See <a class="hxr-hoverxref hxr-tooltip reference internal" href="settings.html#std-setting-FTP_PASSWORD"><code class="xref std std-setting docutils literal notranslate"><span class="pre">FTP_PASSWORD</span></code></a> for more info)</p></li>
<li><p><code class="docutils literal notranslate"><span class="pre">ftp_user</span></code> (See <a class="hxr-hoverxref hxr-tooltip reference internal" href="settings.html#std-setting-FTP_USER"><code class="xref std std-setting docutils literal notranslate"><span class="pre">FTP_USER</span></code></a> for more info)</p></li>
<li><p><a class="hxr-hoverxref hxr-tooltip reference internal" href="spider-middleware.html#std-reqmeta-handle_httpstatus_all"><code class="xref std std-reqmeta docutils literal notranslate"><span class="pre">handle_httpstatus_all</span></code></a></p></li>
<li><p><a class="hxr-hoverxref hxr-tooltip reference internal" href="spider-middleware.html#std-reqmeta-handle_httpstatus_list"><code class="xref std std-reqmeta docutils literal notranslate"><span class="pre">handle_httpstatus_list</span></code></a></p></li>
<li><p><a class="hxr-hoverxref hxr-tooltip reference internal" href="spider-middleware.html#std-reqmeta-is_start_request"><code class="xref std std-reqmeta docutils literal notranslate"><span class="pre">is_start_request</span></code></a></p></li>
...
<li><p><a class="hxr-hoverxref hxr-tooltip reference internal" href="downloader-middleware.html#std-reqmeta-proxy"><code class="xref std std-reqmeta docutils literal notranslate"><span class="pre">proxy</span></code></a></p></li>
<li><p><a class="hxr-hoverxref hxr-tooltip reference internal" href="downloader-middleware.html#std-reqmeta-redirect_reasons"><code class="xref std std-reqmeta docutils literal notranslate"><span class="pre">redirect_reasons</span></code></a></p></li>
<li><p><a class="hxr-hoverxref hxr-tooltip reference internal" href="downloader-middleware.html#std-reqmeta-redirect_urls"><code class="xref std std-reqmeta docutils literal notranslate"><span class="pre">redirect_urls</span></code></a></p></li>
<li><p><a class="hxr-hoverxref hxr-tooltip reference internal" href="spider-middleware.html#std-reqmeta-referrer_policy"><code class="xref std std-reqmeta docutils literal notranslate"><span class="pre">referrer_policy</span></code></a></p></li>
</ul>
<section id="bindaddress">
<span id="std-reqmeta-bindaddress"></span><h3>bindaddress<a class="headerlink" href="#bindaddress" title="Link to this heading"></a></h3>
<p>The IP of the outgoing IP address to use for the performing the request.</p>
</section>
<section id="download-timeout">
<span id="std-reqmeta-download_timeout"></span><h3>download_timeout<a class="headerlink" href="#download-timeout" title="Link to this heading"></a></h3>
<p>The amount of time (in secs) that the downloader will wait before timing out.
See also: <a class="hxr-hoverxref hxr-tooltip reference internal" href="settings.html#std-setting-DOWNLOAD_TIMEOUT"><code class="xref std std-setting docutils literal notranslate"><span class="pre">DOWNLOAD_TIMEOUT</span></code></a>.</p>
</section>
<section id="download-latency">
<span id="std-reqmeta-download_latency"></span><h3>download_latency<a class="headerlink" href="#download-latency" title="Link to this heading"></a></h3>
...
<span id="std-reqmeta-download_fail_on_dataloss"></span><h3>download_fail_on_dataloss<a class="headerlink" href="#download-fail-on-dataloss" title="Link to this heading"></a></h3>
<p>Whether or not to fail on broken responses. See:
<a class="hxr-hoverxref hxr-tooltip reference internal" href="settings.html#std-setting-DOWNLOAD_FAIL_ON_DATALOSS"><code class="xref std std-setting docutils literal notranslate"><span class="pre">DOWNLOAD_FAIL_ON_DATALOSS</span></code></a>.</p>
</section>
<section id="max-retry-times">
<span id="std-reqmeta-max_retry_times"></span><h3>max_retry_times<a class="headerlink" href="#max-retry-times" title="Link to this heading"></a></h3>
...
<a class="hxr-hoverxref hxr-tooltip reference internal" href="downloader-middleware.html#std-setting-RETRY_TIMES"><code class="xref std std-setting docutils literal notranslate"><span class="pre">RETRY_TIMES</span></code></a> setting.</p>
</section>
</section>
<section id="stopping-the-download-of-a-response">
<span id="topics-stop-response-download"></span><h2>Stopping the download of a Response<a class="headerlink" href="#stopping-the-download-of-a-response" title="Link to this heading"></a></h2>
<p>Raising a <a class="reference internal" href="exceptions.html#scrapy.exceptions.StopDownload" title="scrapy.exceptions.StopDownload"><code class="xref py py-exc docutils literal notranslate"><span class="pre">StopDownload</span></code></a> exception from a handler for the
<a class="reference internal" href="signals.html#scrapy.signals.bytes_received" title="scrapy.signals.bytes_received"><code class="xref py py-class docutils literal notranslate"><span class="pre">bytes_received</span></code></a> or <a class="reference internal" href="signals.html#scrapy.signals.headers_received" title="scrapy.signals.headers_received"><code class="xref py py-class docutils literal notranslate"><span class="pre">headers_received</span></code></a>
signals will stop the download of a given response. See the following example:</p>
<div class="highlight-python notranslate"><div class="highlight"><pre><span></span><span class="kn">import</span><span class="w"> </span><span class="nn">scrapy</span>


<span class="k">class</span><span class="w"> </span><span class="nc">StopSpider</span><span class="p">(</span><span class="n">scrapy</span><span class="o">.</span><span class="n">Spider</span><span class="p">):</span>
    ...
    <span class="k">def</span><span class="w"> </span><span class="nf">on_bytes_received</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">data</span><span class="p">,</span> <span class="n">request</span><span class="p">,</span> <span class="n">spider</span><span class="p">):</span>
...
<span class="mi">2020</span><span class="o">-</span><span class="mi">05</span><span class="o">-</span><span class="mi">19</span> <span class="mi">17</span><span class="p">:</span><span class="mi">26</span><span class="p">:</span><span class="mi">13</span> <span class="p">[</span><span class="n">scrapy</span><span class="o">.</span><span class="n">core</span><span class="o">.</span><span class="n">scraper</span><span class="p">]</span> <span class="n">DEBUG</span><span class="p">:</span> <span class="n">Scraped</span> <span class="kn">from</span><span class="w"> </span><span class="o">&lt;</span><span class="mi">200</span> <span class="n">https</span><span class="p">:</span><span class="o">//</span><span class="n">docs</span><span class="o">.</span><span class="n">scrapy</span><span class="o">.</span><span class="n">org</span><span class="o">/</span><span class="n">en</span><span class="o">/</span><span class="n">latest</span><span class="o">/&gt;</span>
...
<a class="reference internal" href="exceptions.html#scrapy.exceptions.StopDownload" title="scrapy.exceptions.StopDownload"><code class="xref py py-exc docutils literal notranslate"><span class="pre">StopDownload</span></code></a> exception.</p>
</section>
<section id="request-subclasses">
<span id="topics-request-response-ref-request-subclasses"></span><h2>Request subclasses<a class="headerlink" href="#request-subclasses" title="Link to this heading"></a></h2>
<p>Here is the list of built-in <a class="reference internal" href="#scrapy.Request" title="scrapy.Request"><code class="xref py py-class docutils literal notranslate"><span class="pre">Request</span></code></a> subclasses. You can also subclass
it to implement your own custom functionality.</p>
<section id="formrequest-objects">
<h3>FormRequest objects<a class="headerlink" href="#formrequest-objects" title="Link to this heading"></a></h3>
<p>The FormRequest class extends the base <a class="reference internal" href="#scrapy.Request" title="scrapy.Request"><code class="xref py py-class docutils literal notranslate"><span class="pre">Request</span></code></a> with functionality for
...
<dl class="py class">
<dt class="sig sig-object py" id="scrapy.FormRequest">
<em class="property"><span class="pre">class</span><span class="w"> </span></em><span class="sig-prename descclassname"><span class="pre">scrapy.</span></span><span class="sig-name descname"><span class="pre">FormRequest</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">url</span></span></em><span class="optional">[</span>, <em class="sig-param"><span class="n"><span class="pre">formdata</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">...</span></span></em><span class="optional">]</span><span class="sig-paren">)</span><a class="headerlink" href="#scrapy.FormRequest" title="Link to this definition"></a></dt>
<dd><p>The <a class="reference internal" href="#scrapy.FormRequest" title="scrapy.FormRequest"><code class="xref py py-class docutils literal notranslate"><span class="pre">FormRequest</span></code></a> class adds a new keyword parameter to the <code class="docutils literal notranslate"><span class="pre">__init__()</span></code> method. The
remaining arguments are the same as for the <a class="reference internal" href="#scrapy.Request" title="scrapy.Request"><code class="xref py py-class docutils literal notranslate"><span class="pre">Request</span></code></a> class and are
...
<p>The <a class="reference internal" href="#scrapy.FormRequest" title="scrapy.FormRequest"><code class="xref py py-class docutils literal notranslate"><span class="pre">FormRequest</span></code></a> objects support the following class method in
addition to the standard <a class="reference internal" href="#scrapy.Request" title="scrapy.Request"><code class="xref py py-class docutils literal notranslate"><span class="pre">Request</span></code></a> methods:</p>
<dl class="py method">
<dt class="sig sig-object py" id="scrapy.FormRequest.from_response">
<em class="property"><span class="pre">classmethod</span><span class="w"> </span></em><span class="sig-name descname"><span class="pre">from_response</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">response</span></span></em><span class="optional">[</span>, <em class="sig-param"><span class="n"><span class="pre">formname=None</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">formid=None</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">formnumber=0</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">formdata=None</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">formxpath=None</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">formcss=None</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">clickdata=None</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">dont_click=False</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">...</span></span></em><span class="optional">]</span><span class="sig-paren">)</span><a class="headerlink" href="#scrapy.FormRequest.from_response" title="Link to this definition"></a></dt>
<dd><p>Returns a new <a class="reference internal" href="#scrapy.FormRequest" title="scrapy.FormRequest"><code class="xref py py-class docutils literal notranslate"><span class="pre">FormRequest</span></code></a> object with its form field values
...
javascript, the default <a class="reference internal" href="#scrapy.FormRequest.from_response" title="scrapy.FormRequest.from_response"><code class="xref py py-meth docutils literal notranslate"><span class="pre">from_response()</span></code></a> behaviour may not be the
...
<a class="reference internal" href="#scrapy.FormRequest" title="scrapy.FormRequest"><code class="xref py py-class docutils literal notranslate"><span class="pre">FormRequest</span></code></a> <code class="docutils literal notranslate"><span class="pre">__init__()</span></code> method.</p>
</dd></dl>
...
<h3>Request usage examples<a class="headerlink" href="#request-usage-examples" title="Link to this heading"></a></h3>
<section id="using-formrequest-to-send-data-via-http-post">
<h4>Using FormRequest to send data via HTTP POST<a class="headerlink" href="#using-formrequest-to-send-data-via-http-post" title="Link to this heading"></a></h4>
<p>If you want to simulate a HTML Form POST in your spider and send a couple of
key-value fields, you can return a <a class="reference internal" href="#scrapy.FormRequest" title="scrapy.FormRequest"><code class="xref py py-class docutils literal notranslate"><span class="pre">FormRequest</span></code></a> object (from your
spider) like this:</p>
...
<span id="topics-request-response-ref-request-userlogin"></span><h4>Using FormRequest.from_response() to simulate a user login<a class="headerlink" href="#using-formrequest-from-response-to-simulate-a-user-login" title="Link to this heading"></a></h4>
...
user name and password. You can use the <a class="reference internal" href="#scrapy.FormRequest.from_response" title="scrapy.FormRequest.from_response"><code class="xref py py-meth docutils literal notranslate"><span class="pre">FormRequest.from_response()</span></code></a>
method for this job. Here’s an example spider which uses it:</p>
<div class="highlight-python notranslate"><div class="highlight"><pre><span></span><span class="kn">import</span><span class="w"> </span><span class="nn">scrapy</span>


<span class="k">def</span><span class="w"> </span><span class="nf">authentication_failed</span><span class="p">(</span><span class="n">response</span><span class="p">):</span>
...
<span class="k">class</span><span class="w"> </span><span class="nc">LoginSpider</span><span class="p">(</span><span class="n">scrapy</span><span class="o">.</span><span class="n">Spider</span><span class="p">):</span>
    ...
    <span class="k">def</span><span class="w"> </span><span class="nf">after_login</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span> <span class="n">response</span><span class="p">):</span>
...
<h3>JsonRequest<a class="headerlink" href="#jsonrequest" title="Link to this heading"></a></h3>
<p>The JsonRequest class extends the base <a class="reference internal" href="#scrapy.Request" title="scrapy.Request"><code class="xref py py-class docutils literal notranslate"><span class="pre">Request</span></code></a> class with functionality for
dealing with JSON requests.</p>
<dl class="py class">
<dt class="sig sig-object py" id="scrapy.http.JsonRequest">
<em class="property"><span class="pre">class</span><span class="w"> </span></em><span class="sig-prename descclassname"><span class="pre">scrapy.http.</span></span><span class="sig-name descname"><span class="pre">JsonRequest</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">url</span></span></em><span class="optional">[</span>, <em class="sig-param"><span class="n"><span class="pre">...</span> <span class="pre">data</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">dumps_kwargs</span></span></em><span class="optional">]</span><span class="sig-paren">)</span><a class="reference internal" href="../_modules/scrapy/http/request/json_request.html#JsonRequest"><span class="viewcode-link"><span class="pre">[source]</span></span></a><a class="headerlink" href="#scrapy.http.JsonRequest" title="Link to this definition"></a></dt>
...
If the <a class="reference internal" href="#scrapy.Request.body" title="scrapy.Request.body"><code class="xref py py-attr docutils literal notranslate"><span class="pre">body</span></code></a> argument is provided this parameter will be ignored.
If the <a class="reference internal" href="#scrapy.Request.body" title="scrapy.Request.body"><code class="xref py py-attr docutils literal notranslate"><span class="pre">body</span></code></a> argument is not provided and the
<code class="docutils literal notranslate"><span class="pre">data</span></code> argument is provided the <a class="reference internal" href="#scrapy.Request.method" title="scrapy.Request.method"><code class="xref py py-attr docutils literal notranslate"><span class="pre">method</span></code></a> will be
...
<span class="sig-name descname"><span class="pre">attributes</span></span><em class="property"><span class="p"><span class="pre">:</span></span><span class="w"> </span><a class="reference external" href="https://docs.python.org/3/library/stdtypes.html#tuple" title="(in Python v3.13)"><span class="pre">tuple</span></a><span class="p"><span class="pre">[</span></span><a class="reference external" href="https://docs.python.org/3/library/stdtypes.html#str" title="(in Python v3.13)"><span class="pre">str</span></a><span class="p"><span class="pre">,</span></span><span class="w"> </span><span class="p"><span class="pre">...</span></span><span class="p"><span class="pre">]</span></span></em><em class="property"><span class="w"> </span><span class="p"><span class="pre">=</span></span><span class="w"> </span><span class="pre">('url',</span> <span class="pre">'callback',</span> <span class="pre">'method',</span> <span class="pre">'headers',</span> <span class="pre">'body',</span> <span class="pre">'cookies',</span> <span class="pre">'meta',</span> <span class="pre">'encoding',</span> <span class="pre">'priority',</span> <span class="pre">'dont_filter',</span> <span class="pre">'errback',</span> <span class="pre">'flags',</span> <span class="pre">'cb_kwargs',</span> <span class="pre">'dumps_kwargs')</span></em><a class="headerlink" href="#scrapy.http.JsonRequest.attributes" title="Link to this definition"></a></dt>
<dd><p>A tuple of <a class="reference external" href="https://docs.python.org/3/library/stdtypes.html#str" title="(in Python v3.13)"><code class="xref py py-class docutils literal notranslate"><span class="pre">str</span></code></a> objects containing the name of all public
attributes of the class that are also keyword parameters of the
<code class="docutils literal notranslate"><span class="pre">__init__()</span></code> method.</p>
<p>Currently used by <a class="reference internal" href="#scrapy.Request.replace" title="scrapy.Request.replace"><code class="xref py py-meth docutils literal notranslate"><span class="pre">Request.replace()</span></code></a>, <a class="reference internal" href="#scrapy.Request.to_dict" title="scrapy.Request.to_dict"><code class="xref py py-meth docutils literal notranslate"><span class="pre">Request.to_dict()</span></code></a> and
...
<h3>JsonRequest usage example<a class="headerlink" href="#jsonrequest-usage-example" title="Link to this heading"></a></h3>
...
<em class="property"><span class="pre">class</span><span class="w"> </span></em><span class="sig-prename descclassname"><span class="pre">scrapy.http.</span></span><span class="sig-name descname"><span class="pre">Response</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="o"><span class="pre">*</span></span><span class="n"><span class="pre">args</span></span><span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="n"><span class="pre">Any</span></span></em>, <em class="sig-param"><span class="o"><span class="pre">**</span></span><span class="n"><span class="pre">kwargs</span></span><span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="n"><span class="pre">Any</span></span></em><span class="sig-paren">)</span><a class="reference internal" href="../_modules/scrapy/http/response.html#Response"><span class="viewcode-link"><span class="pre">[source]</span></span></a><a class="headerlink" href="#scrapy.http.Response" title="Link to this definition"></a></dt>
...
copied.</p></li>
<li><p><strong>request</strong> (<a class="reference internal" href="#scrapy.Request" title="scrapy.Request"><em>scrapy.Request</em></a>) – the initial value of the <a class="reference internal" href="#scrapy.http.Response.request" title="scrapy.http.Response.request"><code class="xref py py-attr docutils literal notranslate"><span class="pre">Response.request</span></code></a> attribute.
This represents the <a class="reference internal" href="#scrapy.Request" title="scrapy.Request"><code class="xref py py-class docutils literal notranslate"><span class="pre">Request</span></code></a> that generated this response.</p></li>
...
<div class="versionadded">
<p><span class="versionmodified added">Added in version 2.0.0: </span>The <code class="docutils literal notranslate"><span class="pre">certificate</span></code> parameter.</p>
</div>
<div class="versionadded">
<p><span class="versionmodified added">Added in version 2.1.0: </span>The <code class="docutils literal notranslate"><span class="pre">ip_address</span></code> parameter.</p>
</div>
<div class="versionadded">
<p><span class="versionmodified added">Added in version 2.5.0: </span>The <code class="docutils literal notranslate"><span class="pre">protocol</span></code> parameter.</p>
</div>
<dl class="py attribute">
<dt class="sig sig-object py" id="scrapy.http.Response.url">
<span class="sig-name descname"><span class="pre">url</span></span><a class="headerlink" href="#scrapy.http.Response.url" title="Link to this definition"></a></dt>
...
<span class="sig-name descname"><span class="pre">status</span></span><a class="headerlink" href="#scrapy.http.Response.status" title="Link to this definition"></a></dt>
...
<span class="sig-name descname"><span class="pre">headers</span></span><a class="headerlink" href="#scrapy.http.Response.headers" title="Link to this definition"></a></dt>
<dd><p>A dictionary-like (<code class="xref py py-class docutils literal notranslate"><span class="pre">scrapy.http.headers.Headers</span></code>) object which contains
the response headers. Values can be accessed using
<code class="xref py py-meth docutils literal notranslate"><span class="pre">get()</span></code> to return the first header value with
the specified name or <code class="xref py py-meth docutils literal notranslate"><span class="pre">getlist()</span></code> to return
all header values with the specified name. For example, this call will give you
all cookies in the headers:</p>
...
<span class="sig-name descname"><span class="pre">body</span></span><a class="headerlink" href="#scrapy.http.Response.body" title="Link to this definition"></a></dt>
...
<span class="sig-name descname"><span class="pre">request</span></span><a class="headerlink" href="#scrapy.http.Response.request" title="Link to this definition"></a></dt>
<dd><p>The <a class="reference internal" href="#scrapy.Request" title="scrapy.Request"><code class="xref py py-class docutils literal notranslate"><span class="pre">Request</span></code></a> object that generated this response. This attribute is
assigned in the Scrapy engine, after the response and the request have passed
through all <a class="hxr-hoverxref hxr-tooltip reference internal" href="downloader-middleware.html#topics-downloader-middleware"><span class="std std-ref">Downloader Middlewares</span></a>.
...
<a class="hxr-hoverxref hxr-tooltip reference internal" href="spider-middleware.html#topics-spider-middleware"><span class="std std-ref">Spider Middlewares</span></a>, but not in
Downloader Middlewares (although you have the Request available there by
other means) and handlers of the <a class="hxr-hoverxref hxr-tooltip reference internal" href="signals.html#std-signal-response_downloaded"><code class="xref std std-signal docutils literal notranslate"><span class="pre">response_downloaded</span></code></a> signal.</p></li>
</ul>
</dd></dl>

<dl class="py attribute">
<dt class="sig sig-object py" id="scrapy.http.Response.meta">
<span class="sig-name descname"><span class="pre">meta</span></span><a class="headerlink" href="#scrapy.http.Response.meta" title="Link to this definition"></a></dt>
<dd><p>A shortcut to the <a class="reference internal" href="#scrapy.Request.meta" title="scrapy.Request.meta"><code class="xref py py-attr docutils literal notranslate"><span class="pre">meta</span></code></a> attribute of the
...
the original <a class="reference internal" href="#scrapy.Request.meta" title="scrapy.Request.meta"><code class="xref py py-attr docutils literal notranslate"><span class="pre">Request.meta</span></code></a> sent from your spider.</p>
<div class="admonition seealso">
<p class="admonition-title">See also</p>
<p><a class="reference internal" href="#scrapy.Request.meta" title="scrapy.Request.meta"><code class="xref py py-attr docutils literal notranslate"><span class="pre">Request.meta</span></code></a> attribute</p>
</div>
</dd></dl>

<dl class="py attribute">
<dt class="sig sig-object py" id="scrapy.http.Response.cb_kwargs">
<span class="sig-name descname"><span class="pre">cb_kwargs</span></span><a class="headerlink" href="#scrapy.http.Response.cb_kwargs" title="Link to this definition"></a></dt>
<dd><div class="versionadded">
<p><span class="versionmodified added">Added in version 2.0.</span></p>
</div>
<p>A shortcut to the <a class="reference internal" href="#scrapy.Request.cb_kwargs" title="scrapy.Request.cb_kwargs"><code class="xref py py-attr docutils literal notranslate"><span class="pre">cb_kwargs</span></code></a> attribute of the
...
retries, so you will get the original <a class="reference internal" href="#scrapy.Request.cb_kwargs" title="scrapy.Request.cb_kwargs"><code class="xref py py-attr docutils literal notranslate"><span class="pre">Request.cb_kwargs</span></code></a> sent from your spider.</p>
<div class="admonition seealso">
<p class="admonition-title">See also</p>
<p><a class="reference internal" href="#scrapy.Request.cb_kwargs" title="scrapy.Request.cb_kwargs"><code class="xref py py-attr docutils literal notranslate"><span class="pre">Request.cb_kwargs</span></code></a> attribute</p>
</div>
</dd></dl>

<dl class="py attribute">
<dt class="sig sig-object py" id="scrapy.http.Response.flags">
<span class="sig-name descname"><span class="pre">flags</span></span><a class="headerlink" href="#scrapy.http.Response.flags" title="Link to this definition"></a></dt>
...
they’re shown on the string representation of the Response (<code class="docutils literal notranslate"><span class="pre">__str__()</span></code>
method) which is used by the engine for logging.</p>
</dd></dl>

<dl class="py attribute">
<dt class="sig sig-object py" id="scrapy.http.Response.certificate">
<span class="sig-name descname"><span class="pre">certificate</span></span><a class="headerlink" href="#scrapy.http.Response.certificate" title="Link to this definition"></a></dt>
<dd><div class="versionadded">
...
<span class="sig-name descname"><span class="pre">ip_address</span></span><a class="headerlink" href="#scrapy.http.Response.ip_address" title="Link to this definition"></a></dt>
<dd><div class="versionadded">
...
<span class="sig-name descname"><span class="pre">protocol</span></span><a class="headerlink" href="#scrapy.http.Response.protocol" title="Link to this definition"></a></dt>
<dd><div class="versionadded">
...
<span class="sig-name descname"><span class="pre">copy</span></span><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="reference internal" href="../_modules/scrapy/http/response.html#Response.copy"><span class="viewcode-link"><span class="pre">[source]</span></span></a><a class="headerlink" href="#scrapy.http.Response.copy" title="Link to this definition"></a></dt>
<dd><p>Returns a new Response which is a copy of this Response.</p>
</dd></dl>

<dl class="py method">
<dt class="sig sig-object py" id="scrapy.http.Response.replace">
<span class="sig-name descname"><span class="pre">replace</span></span><span class="sig-paren">(</span><span class="optional">[</span><em class="sig-param"><span class="n"><span class="pre">url</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">status</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">headers</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">body</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">request</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">flags</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">cls</span></span></em><span class="optional">]</span><span class="sig-paren">)</span><a class="reference internal" href="../_modules/scrapy/http/response.html#Response.replace"><span class="viewcode-link"><span class="pre">[source]</span></span></a><a class="headerlink" href="#scrapy.http.Response.replace" title="Link to this definition"></a></dt>
...
<span class="sig-name descname"><span class="pre">urljoin</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">url</span></span></em><span class="sig-paren">)</span><a class="reference internal" href="../_modules/scrapy/http/response.html#Response.urljoin"><span class="viewcode-link"><span class="pre">[source]</span></span></a><a class="headerlink" href="#scrapy.http.Response.urljoin" title="Link to this definition"></a></dt>
...
but <code class="docutils literal notranslate"><span class="pre">url</span></code> can be a relative URL or a <a class="reference internal" href="link-extractors.html#scrapy.link.Link" title="scrapy.link.Link"><code class="xref py py-class docutils literal notranslate"><span class="pre">Link</span></code></a> object,
...
and Link objects.</p>
<div class="versionadded">
<p><span class="versionmodified added">Added in version 2.0: </span>The <em>flags</em> parameter.</p>
</div>
</dd></dl>

<dl class="py method">
<dt class="sig sig-object py" id="scrapy.http.Response.follow_all">
<span class="sig-name descname"><span class="pre">follow_all</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">urls</span></span><span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="n"><span class="pre">Iterable</span><span class="p"><span class="pre">[</span></span><a class="reference external" href="https://docs.python.org/3/library/stdtypes.html#str" title="(in Python v3.13)"><span class="pre">str</span></a><span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><a class="reference internal" href="link-extractors.html#scrapy.link.Link" title="scrapy.link.Link"><span class="pre">Link</span></a><span class="p"><span class="pre">]</span></span></span></em>, <em class="sig-param"><span class="n"><span class="pre">callback</span></span><span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="n"><span class="pre">CallbackT</span><span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><a class="reference external" href="https://docs.python.org/3/library/constants.html#None" title="(in Python v3.13)"><span class="pre">None</span></a></span><span class="w"> </span><span class="o"><span class="pre">=</span></span><span class="w"> </span><span class="default_value"><span class="pre">None</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">method</span></span><span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="n"><a class="reference external" href="https://docs.python.org/3/library/stdtypes.html#str" title="(in Python v3.13)"><span class="pre">str</span></a></span><span class="w"> </span><span class="o"><span class="pre">=</span></span><span class="w"> </span><span class="default_value"><span class="pre">'GET'</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">headers</span></span><span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="n"><span class="pre">Mapping</span><span class="p"><span class="pre">[</span></span><span class="pre">AnyStr</span><span class="p"><span class="pre">,</span></span><span class="w"> </span><span class="pre">Any</span><span class="p"><span class="pre">]</span></span><span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><span class="pre">Iterable</span><span class="p"><span class="pre">[</span></span><a class="reference external" href="https://docs.python.org/3/library/stdtypes.html#tuple" title="(in Python v3.13)"><span class="pre">tuple</span></a><span class="p"><span class="pre">[</span></span><span class="pre">AnyStr</span><span class="p"><span class="pre">,</span></span><span class="w"> </span><span class="pre">Any</span><span class="p"><span class="pre">]</span></span><span class="p"><span class="pre">]</span></span><span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><a class="reference external" href="https://docs.python.org/3/library/constants.html#None" title="(in Python v3.13)"><span class="pre">None</span></a></span><span class="w"> </span><span class="o"><span class="pre">=</span></span><span class="w"> </span><span class="default_value"><span class="pre">None</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">body</span></span><span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="n"><a class="reference external" href="https://docs.python.org/3/library/stdtypes.html#bytes" title="(in Python v3.13)"><span class="pre">bytes</span></a><span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><a class="reference external" href="https://docs.python.org/3/library/stdtypes.html#str" title="(in Python v3.13)"><span class="pre">str</span></a><span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><a class="reference external" href="https://docs.python.org/3/library/constants.html#None" title="(in Python v3.13)"><span class="pre">None</span></a></span><span class="w"> </span><span class="o"><span class="pre">=</span></span><span class="w"> </span><span class="default_value"><span class="pre">None</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">cookies</span></span><span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="n"><span class="pre">CookiesT</span><span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><a class="reference external" href="https://docs.python.org/3/library/constants.html#None" title="(in Python v3.13)"><span class="pre">None</span></a></span><span class="w"> </span><span class="o"><span class="pre">=</span></span><span class="w"> </span><span class="default_value"><span class="pre">None</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">meta</span></span><span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="n"><a class="reference external" href="https://docs.python.org/3/library/stdtypes.html#dict" title="(in Python v3.13)"><span class="pre">dict</span></a><span class="p"><span class="pre">[</span></span><a class="reference external" href="https://docs.python.org/3/library/stdtypes.html#str" title="(in Python v3.13)"><span class="pre">str</span></a><span class="p"><span class="pre">,</span></span><span class="w"> </span><span class="pre">Any</span><span class="p"><span class="pre">]</span></span><span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><a class="reference external" href="https://docs.python.org/3/library/constants.html#None" title="(in Python v3.13)"><span class="pre">None</span></a></span><span class="w"> </span><span class="o"><span class="pre">=</span></span><span class="w"> </span><span class="default_value"><span class="pre">None</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">encoding</span></span><span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="n"><a class="reference external" href="https://docs.python.org/3/library/stdtypes.html#str" title="(in Python v3.13)"><span class="pre">str</span></a><span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><a class="reference external" href="https://docs.python.org/3/library/constants.html#None" title="(in Python v3.13)"><span class="pre">None</span></a></span><span class="w"> </span><span class="o"><span class="pre">=</span></span><span class="w"> </span><span class="default_value"><span class="pre">'utf-8'</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">priority</span></span><span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="n"><a class="reference external" href="https://docs.python.org/3/library/functions.html#int" title="(in Python v3.13)"><span class="pre">int</span></a></span><span class="w"> </span><span class="o"><span class="pre">=</span></span><span class="w"> </span><span class="default_value"><span class="pre">0</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">dont_filter</span></span><span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="n"><a class="reference external" href="https://docs.python.org/3/library/functions.html#bool" title="(in Python v3.13)"><span class="pre">bool</span></a></span><span class="w"> </span><span class="o"><span class="pre">=</span></span><span class="w"> </span><span class="default_value"><span class="pre">False</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">errback</span></span><span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="n"><span class="pre">Callable</span><span class="p"><span class="pre">[</span></span><span class="p"><span class="pre">[</span></span><span class="pre">Failure</span><span class="p"><span class="pre">]</span></span><span class="p"><span class="pre">,</span></span><span class="w"> </span><span class="pre">Any</span><span class="p"><span class="pre">]</span></span><span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><a class="reference external" href="https://docs.python.org/3/library/constants.html#None" title="(in Python v3.13)"><span class="pre">None</span></a></span><span class="w"> </span><span class="o"><span class="pre">=</span></span><span class="w"> </span><span class="default_value"><span class="pre">None</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">cb_kwargs</span></span><span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="n"><a class="reference external" href="https://docs.python.org/3/library/stdtypes.html#dict" title="(in Python v3.13)"><span class="pre">dict</span></a><span class="p"><span class="pre">[</span></span><a class="reference external" href="https://docs.python.org/3/library/stdtypes.html#str" title="(in Python v3.13)"><span class="pre">str</span></a><span class="p"><span class="pre">,</span></span><span class="w"> </span><span class="pre">Any</span><span class="p"><span class="pre">]</span></span><span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><a class="reference external" href="https://docs.python.org/3/library/constants.html#None" title="(in Python v3.13)"><span class="pre">None</span></a></span><span class="w"> </span><span class="o"><span class="pre">=</span></span><span class="w"> </span><span class="default_value"><span class="pre">None</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">flags</span></span><span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="n"><a class="reference external" href="https://docs.python.org/3/library/stdtypes.html#list" title="(in Python v3.13)"><span class="pre">list</span></a><span class="p"><span class="pre">[</span></span><a class="reference external" href="https://docs.python.org/3/library/stdtypes.html#str" title="(in Python v3.13)"><span class="pre">str</span></a><span class="p"><span class="pre">]</span></span><span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><a class="reference external" href="https://docs.python.org/3/library/constants.html#None" title="(in Python v3.13)"><span class="pre">None</span></a></span><span class="w"> </span><span class="o"><span class="pre">=</span></span><span class="w"> </span><span class="default_value"><span class="pre">None</span></span></em><span class="sig-paren">)</span> <span class="sig-return"><span class="sig-return-icon">&#x2192;</span> <span class="sig-return-typehint"><span class="pre">Iterable</span><span class="p"><span class="pre">[</span></span><a class="reference internal" href="#scrapy.Request" title="scrapy.Request"><span class="pre">Request</span></a><span class="p"><span class="pre">]</span></span></span></span><a class="reference internal" href="../_modules/scrapy/http/response.html#Response.follow_all"><span class="viewcode-link"><span class="pre">[source]</span></span></a><a class="headerlink" href="#scrapy.http.Response.follow_all" title="Link to this definition"></a></dt>
<dd><div class="versionadded">
<p><span class="versionmodified added">Added in version 2.0.</span></p>
</div>
<p>Return an iterable of <a class="reference internal" href="#scrapy.Request" title="scrapy.Request"><code class="xref py py-class docutils literal notranslate"><span class="pre">Request</span></code></a> instances to follow all links
...
<span id="topics-request-response-ref-response-subclasses"></span><h2>Response subclasses<a class="headerlink" href="#response-subclasses" title="Link to this heading"></a></h2>
...
<h3>TextResponse objects<a class="headerlink" href="#textresponse-objects" title="Link to this heading"></a></h3>
<dl class="py class">
<dt class="sig sig-object py" id="scrapy.http.TextResponse">
<em class="property"><span class="pre">class</span><span class="w"> </span></em><span class="sig-prename descclassname"><span class="pre">scrapy.http.</span></span><span class="sig-name descname"><span class="pre">TextResponse</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">url</span></span></em><span class="optional">[</span>, <em class="sig-param"><span class="n"><span class="pre">encoding</span></span></em><span class="optional">[</span>, <em class="sig-param"><span class="n"><span class="pre">...</span></span></em><span class="optional">]</span><span class="optional">]</span><span class="sig-paren">)</span><a class="reference internal" href="../_modules/scrapy/http/response/text.html#TextResponse"><span class="viewcode-link"><span class="pre">[source]</span></span></a><a class="headerlink" href="#scrapy.http.TextResponse" title="Link to this definition"></a></dt>
...
<span class="sig-name descname"><span class="pre">text</span></span><a class="headerlink" href="#scrapy.http.TextResponse.text" title="Link to this definition"></a></dt>
...
<span class="sig-name descname"><span class="pre">encoding</span></span><a class="headerlink" href="#scrapy.http.TextResponse.encoding" title="Link to this definition"></a></dt>
...
<span class="sig-name descname"><span class="pre">selector</span></span><a class="headerlink" href="#scrapy.http.TextResponse.selector" title="Link to this definition"></a></dt>
<dd><p>A <a class="reference internal" href="selectors.html#scrapy.Selector" title="scrapy.Selector"><code class="xref py py-class docutils literal notranslate"><span class="pre">Selector</span></code></a> instance using the response as
...
<span class="sig-name descname"><span class="pre">jmespath</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">query</span></span></em><span class="sig-paren">)</span><a class="reference internal" href="../_modules/scrapy/http/response/text.html#TextResponse.jmespath"><span class="viewcode-link"><span class="pre">[source]</span></span></a><a class="headerlink" href="#scrapy.http.TextResponse.jmespath" title="Link to this definition"></a></dt>
...
<span class="sig-name descname"><span class="pre">xpath</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">query</span></span></em><span class="sig-paren">)</span><a class="reference internal" href="../_modules/scrapy/http/response/text.html#TextResponse.xpath"><span class="viewcode-link"><span class="pre">[source]</span></span></a><a class="headerlink" href="#scrapy.http.TextResponse.xpath" title="Link to this definition"></a></dt>
...
<span class="sig-name descname"><span class="pre">css</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">query</span></span></em><span class="sig-paren">)</span><a class="reference internal" href="../_modules/scrapy/http/response/text.html#TextResponse.css"><span class="viewcode-link"><span class="pre">[source]</span></span></a><a class="headerlink" href="#scrapy.http.TextResponse.css" title="Link to this definition"></a></dt>
...
<span class="sig-name descname"><span class="pre">follow</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">url</span></span><span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="n"><a class="reference external" href="https://docs.python.org/3/library/stdtypes.html#str" title="(in Python v3.13)"><span class="pre">str</span></a><span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><a class="reference internal" href="link-extractors.html#scrapy.link.Link" title="scrapy.link.Link"><span class="pre">Link</span></a><span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><span class="pre">parsel.Selector</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">callback</span></span><span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="n"><span class="pre">CallbackT</span><span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><a class="reference external" href="https://docs.python.org/3/library/constants.html#None" title="(in Python v3.13)"><span class="pre">None</span></a></span><span class="w"> </span><span class="o"><span class="pre">=</span></span><span class="w"> </span><span class="default_value"><span class="pre">None</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">method</span></span><span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="n"><a class="reference external" href="https://docs.python.org/3/library/stdtypes.html#str" title="(in Python v3.13)"><span class="pre">str</span></a></span><span class="w"> </span><span class="o"><span class="pre">=</span></span><span class="w"> </span><span class="default_value"><span class="pre">'GET'</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">headers</span></span><span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="n"><span class="pre">Mapping</span><span class="p"><span class="pre">[</span></span><span class="pre">AnyStr</span><span class="p"><span class="pre">,</span></span><span class="w"> </span><span class="pre">Any</span><span class="p"><span class="pre">]</span></span><span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><span class="pre">Iterable</span><span class="p"><span class="pre">[</span></span><a class="reference external" href="https://docs.python.org/3/library/stdtypes.html#tuple" title="(in Python v3.13)"><span class="pre">tuple</span></a><span class="p"><span class="pre">[</span></span><span class="pre">AnyStr</span><span class="p"><span class="pre">,</span></span><span class="w"> </span><span class="pre">Any</span><span class="p"><span class="pre">]</span></span><span class="p"><span class="pre">]</span></span><span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><a class="reference external" href="https://docs.python.org/3/library/constants.html#None" title="(in Python v3.13)"><span class="pre">None</span></a></span><span class="w"> </span><span class="o"><span class="pre">=</span></span><span class="w"> </span><span class="default_value"><span class="pre">None</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">body</span></span><span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="n"><a class="reference external" href="https://docs.python.org/3/library/stdtypes.html#bytes" title="(in Python v3.13)"><span class="pre">bytes</span></a><span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><a class="reference external" href="https://docs.python.org/3/library/stdtypes.html#str" title="(in Python v3.13)"><span class="pre">str</span></a><span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><a class="reference external" href="https://docs.python.org/3/library/constants.html#None" title="(in Python v3.13)"><span class="pre">None</span></a></span><span class="w"> </span><span class="o"><span class="pre">=</span></span><span class="w"> </span><span class="default_value"><span class="pre">None</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">cookies</span></span><span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="n"><span class="pre">CookiesT</span><span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><a class="reference external" href="https://docs.python.org/3/library/constants.html#None" title="(in Python v3.13)"><span class="pre">None</span></a></span><span class="w"> </span><span class="o"><span class="pre">=</span></span><span class="w"> </span><span class="default_value"><span class="pre">None</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">meta</span></span><span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="n"><a class="reference external" href="https://docs.python.org/3/library/stdtypes.html#dict" title="(in Python v3.13)"><span class="pre">dict</span></a><span class="p"><span class="pre">[</span></span><a class="reference external" href="https://docs.python.org/3/library/stdtypes.html#str" title="(in Python v3.13)"><span class="pre">str</span></a><span class="p"><span class="pre">,</span></span><span class="w"> </span><span class="pre">Any</span><span class="p"><span class="pre">]</span></span><span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><a class="reference external" href="https://docs.python.org/3/library/constants.html#None" title="(in Python v3.13)"><span class="pre">None</span></a></span><span class="w"> </span><span class="o"><span class="pre">=</span></span><span class="w"> </span><span class="default_value"><span class="pre">None</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">encoding</span></span><span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="n"><a class="reference external" href="https://docs.python.org/3/library/stdtypes.html#str" title="(in Python v3.13)"><span class="pre">str</span></a><span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><a class="reference external" href="https://docs.python.org/3/library/constants.html#None" title="(in Python v3.13)"><span class="pre">None</span></a></span><span class="w"> </span><span class="o"><span class="pre">=</span></span><span class="w"> </span><span class="default_value"><span class="pre">None</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">priority</span></span><span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="n"><a class="reference external" href="https://docs.python.org/3/library/functions.html#int" title="(in Python v3.13)"><span class="pre">int</span></a></span><span class="w"> </span><span class="o"><span class="pre">=</span></span><span class="w"> </span><span class="default_value"><span class="pre">0</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">dont_filter</span></span><span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="n"><a class="reference external" href="https://docs.python.org/3/library/functions.html#bool" title="(in Python v3.13)"><span class="pre">bool</span></a></span><span class="w"> </span><span class="o"><span class="pre">=</span></span><span class="w"> </span><span class="default_value"><span class="pre">False</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">errback</span></span><span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="n"><span class="pre">Callable</span><span class="p"><span class="pre">[</span></span><span class="p"><span class="pre">[</span></span><span class="pre">Failure</span><span class="p"><span class="pre">]</span></span><span class="p"><span class="pre">,</span></span><span class="w"> </span><span class="pre">Any</span><span class="p"><span class="pre">]</span></span><span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><a class="reference external" href="https://docs.python.org/3/library/constants.html#None" title="(in Python v3.13)"><span class="pre">None</span></a></span><span class="w"> </span><span class="o"><span class="pre">=</span></span><span class="w"> </span><span class="default_value"><span class="pre">None</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">cb_kwargs</span></span><span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="n"><a class="reference external" href="https://docs.python.org/3/library/stdtypes.html#dict" title="(in Python v3.13)"><span class="pre">dict</span></a><span class="p"><span class="pre">[</span></span><a class="reference external" href="https://docs.python.org/3/library/stdtypes.html#str" title="(in Python v3.13)"><span class="pre">str</span></a><span class="p"><span class="pre">,</span></span><span class="w"> </span><span class="pre">Any</span><span class="p"><span class="pre">]</span></span><span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><a class="reference external" href="https://docs.python.org/3/library/constants.html#None" title="(in Python v3.13)"><span class="pre">None</span></a></span><span class="w"> </span><span class="o"><span class="pre">=</span></span><span class="w"> </span><span class="default_value"><span class="pre">None</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">flags</span></span><span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="n"><a class="reference external" href="https://docs.python.org/3/library/stdtypes.html#list" title="(in Python v3.13)"><span class="pre">list</span></a><span class="p"><span class="pre">[</span></span><a class="reference external" href="https://docs.python.org/3/library/stdtypes.html#str" title="(in Python v3.13)"><span class="pre">str</span></a><span class="p"><span class="pre">]</span></span><span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><a class="reference external" href="https://docs.python.org/3/library/constants.html#None" title="(in Python v3.13)"><span class="pre">None</span></a></span><span class="w"> </span><span class="o"><span class="pre">=</span></span><span class="w"> </span><span class="default_value"><span class="pre">None</span></span></em><span class="sig-paren">)</span> <span class="sig-return"><span class="sig-return-icon">&#x2192;</span> <span class="sig-return-typehint"><a class="reference internal" href="#scrapy.Request" title="scrapy.Request"><span class="pre">Request</span></a></span></span><a class="reference internal" href="../_modules/scrapy/http/response/text.html#TextResponse.follow"><span class="viewcode-link"><span class="pre">[source]</span></span></a><a class="headerlink" href="#scrapy.http.TextResponse.follow" title="Link to this definition"></a></dt>
<dd><p>Return a <a class="reference internal" href="#scrapy.Request" title="scrapy.Request"><code class="xref py py-class docutils literal notranslate"><span class="pre">Request</span></code></a> instance to follow a link <code class="docutils literal notranslate"><span class="pre">url</span></code>.
It accepts the same arguments as <code class="docutils literal notranslate"><span class="pre">Request.__init__()</span></code> method,
...
<a class="hxr-hoverxref hxr-tooltip reference internal" href="link-extractors.html#topics-link-extractors"><span class="std std-ref">Link Extractors</span></a></p></li>
<li><p>a <a class="reference internal" href="selectors.html#scrapy.Selector" title="scrapy.Selector"><code class="xref py py-class docutils literal notranslate"><span class="pre">Selector</span></code></a> object for a <code class="docutils literal notranslate"><span class="pre">&lt;link&gt;</span></code> or <code class="docutils literal notranslate"><span class="pre">&lt;a&gt;</span></code> element, e.g.
<code class="docutils literal notranslate"><span class="pre">response.css('a.my_link')[0]</span></code></p></li>
<li><p>an attribute <a class="reference internal" href="selectors.html#scrapy.Selector" title="scrapy.Selector"><code class="xref py py-class docutils literal notranslate"><span class="pre">Selector</span></code></a> (not SelectorList), e.g.
...
<p>See <a class="hxr-hoverxref hxr-tooltip reference internal" href="../intro/tutorial.html#response-follow-example"><span class="std std-ref">A shortcut for creating Requests</span></a> for usage examples.</p>
</dd></dl>

<dl class="py method">
<dt class="sig sig-object py" id="scrapy.http.TextResponse.follow_all">
<span class="sig-name descname"><span class="pre">follow_all</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">urls</span></span><span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="n"><span class="pre">Iterable</span><span class="p"><span class="pre">[</span></span><a class="reference external" href="https://docs.python.org/3/library/stdtypes.html#str" title="(in Python v3.13)"><span class="pre">str</span></a><span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><a class="reference internal" href="link-extractors.html#scrapy.link.Link" title="scrapy.link.Link"><span class="pre">Link</span></a><span class="p"><span class="pre">]</span></span><span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><span class="pre">parsel.SelectorList</span><span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><a class="reference external" href="https://docs.python.org/3/library/constants.html#None" title="(in Python v3.13)"><span class="pre">None</span></a></span><span class="w"> </span><span class="o"><span class="pre">=</span></span><span class="w"> </span><span class="default_value"><span class="pre">None</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">callback</span></span><span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="n"><span class="pre">CallbackT</span><span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><a class="reference external" href="https://docs.python.org/3/library/constants.html#None" title="(in Python v3.13)"><span class="pre">None</span></a></span><span class="w"> </span><span class="o"><span class="pre">=</span></span><span class="w"> </span><span class="default_value"><span class="pre">None</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">method</span></span><span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="n"><a class="reference external" href="https://docs.python.org/3/library/stdtypes.html#str" title="(in Python v3.13)"><span class="pre">str</span></a></span><span class="w"> </span><span class="o"><span class="pre">=</span></span><span class="w"> </span><span class="default_value"><span class="pre">'GET'</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">headers</span></span><span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="n"><span class="pre">Mapping</span><span class="p"><span class="pre">[</span></span><span class="pre">AnyStr</span><span class="p"><span class="pre">,</span></span><span class="w"> </span><span class="pre">Any</span><span class="p"><span class="pre">]</span></span><span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><span class="pre">Iterable</span><span class="p"><span class="pre">[</span></span><a class="reference external" href="https://docs.python.org/3/library/stdtypes.html#tuple" title="(in Python v3.13)"><span class="pre">tuple</span></a><span class="p"><span class="pre">[</span></span><span class="pre">AnyStr</span><span class="p"><span class="pre">,</span></span><span class="w"> </span><span class="pre">Any</span><span class="p"><span class="pre">]</span></span><span class="p"><span class="pre">]</span></span><span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><a class="reference external" href="https://docs.python.org/3/library/constants.html#None" title="(in Python v3.13)"><span class="pre">None</span></a></span><span class="w"> </span><span class="o"><span class="pre">=</span></span><span class="w"> </span><span class="default_value"><span class="pre">None</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">body</span></span><span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="n"><a class="reference external" href="https://docs.python.org/3/library/stdtypes.html#bytes" title="(in Python v3.13)"><span class="pre">bytes</span></a><span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><a class="reference external" href="https://docs.python.org/3/library/stdtypes.html#str" title="(in Python v3.13)"><span class="pre">str</span></a><span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><a class="reference external" href="https://docs.python.org/3/library/constants.html#None" title="(in Python v3.13)"><span class="pre">None</span></a></span><span class="w"> </span><span class="o"><span class="pre">=</span></span><span class="w"> </span><span class="default_value"><span class="pre">None</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">cookies</span></span><span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="n"><span class="pre">CookiesT</span><span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><a class="reference external" href="https://docs.python.org/3/library/constants.html#None" title="(in Python v3.13)"><span class="pre">None</span></a></span><span class="w"> </span><span class="o"><span class="pre">=</span></span><span class="w"> </span><span class="default_value"><span class="pre">None</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">meta</span></span><span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="n"><a class="reference external" href="https://docs.python.org/3/library/stdtypes.html#dict" title="(in Python v3.13)"><span class="pre">dict</span></a><span class="p"><span class="pre">[</span></span><a class="reference external" href="https://docs.python.org/3/library/stdtypes.html#str" title="(in Python v3.13)"><span class="pre">str</span></a><span class="p"><span class="pre">,</span></span><span class="w"> </span><span class="pre">Any</span><span class="p"><span class="pre">]</span></span><span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><a class="reference external" href="https://docs.python.org/3/library/constants.html#None" title="(in Python v3.13)"><span class="pre">None</span></a></span><span class="w"> </span><span class="o"><span class="pre">=</span></span><span class="w"> </span><span class="default_value"><span class="pre">None</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">encoding</span></span><span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="n"><a class="reference external" href="https://docs.python.org/3/library/stdtypes.html#str" title="(in Python v3.13)"><span class="pre">str</span></a><span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><a class="reference external" href="https://docs.python.org/3/library/constants.html#None" title="(in Python v3.13)"><span class="pre">None</span></a></span><span class="w"> </span><span class="o"><span class="pre">=</span></span><span class="w"> </span><span class="default_value"><span class="pre">None</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">priority</span></span><span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="n"><a class="reference external" href="https://docs.python.org/3/library/functions.html#int" title="(in Python v3.13)"><span class="pre">int</span></a></span><span class="w"> </span><span class="o"><span class="pre">=</span></span><span class="w"> </span><span class="default_value"><span class="pre">0</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">dont_filter</span></span><span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="n"><a class="reference external" href="https://docs.python.org/3/library/functions.html#bool" title="(in Python v3.13)"><span class="pre">bool</span></a></span><span class="w"> </span><span class="o"><span class="pre">=</span></span><span class="w"> </span><span class="default_value"><span class="pre">False</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">errback</span></span><span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="n"><span class="pre">Callable</span><span class="p"><span class="pre">[</span></span><span class="p"><span class="pre">[</span></span><span class="pre">Failure</span><span class="p"><span class="pre">]</span></span><span class="p"><span class="pre">,</span></span><span class="w"> </span><span class="pre">Any</span><span class="p"><span class="pre">]</span></span><span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><a class="reference external" href="https://docs.python.org/3/library/constants.html#None" title="(in Python v3.13)"><span class="pre">None</span></a></span><span class="w"> </span><span class="o"><span class="pre">=</span></span><span class="w"> </span><span class="default_value"><span class="pre">None</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">cb_kwargs</span></span><span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="n"><a class="reference external" href="https://docs.python.org/3/library/stdtypes.html#dict" title="(in Python v3.13)"><span class="pre">dict</span></a><span class="p"><span class="pre">[</span></span><a class="reference external" href="https://docs.python.org/3/library/stdtypes.html#str" title="(in Python v3.13)"><span class="pre">str</span></a><span class="p"><span class="pre">,</span></span><span class="w"> </span><span class="pre">Any</span><span class="p"><span class="pre">]</span></span><span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><a class="reference external" href="https://docs.python.org/3/library/constants.html#None" title="(in Python v3.13)"><span class="pre">None</span></a></span><span class="w"> </span><span class="o"><span class="pre">=</span></span><span class="w"> </span><span class="default_value"><span class="pre">None</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">flags</span></span><span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="n"><a class="reference external" href="https://docs.python.org/3/library/stdtypes.html#list" title="(in Python v3.13)"><span class="pre">list</span></a><span class="p"><span class="pre">[</span></span><a class="reference external" href="https://docs.python.org/3/library/stdtypes.html#str" title="(in Python v3.13)"><span class="pre">str</span></a><span class="p"><span class="pre">]</span></span><span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><a class="reference external" href="https://docs.python.org/3/library/constants.html#None" title="(in Python v3.13)"><span class="pre">None</span></a></span><span class="w"> </span><span class="o"><span class="pre">=</span></span><span class="w"> </span><span class="default_value"><span class="pre">None</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">css</span></span><span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="n"><a class="reference external" href="https://docs.python.org/3/library/stdtypes.html#str" title="(in Python v3.13)"><span class="pre">str</span></a><span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><a class="reference external" href="https://docs.python.org/3/library/constants.html#None" title="(in Python v3.13)"><span class="pre">None</span></a></span><span class="w"> </span><span class="o"><span class="pre">=</span></span><span class="w"> </span><span class="default_value"><span class="pre">None</span></span></em>, <em class="sig-param"><span class="n"><span class="pre">xpath</span></span><span class="p"><span class="pre">:</span></span><span class="w"> </span><span class="n"><a class="reference external" href="https://docs.python.org/3/library/stdtypes.html#str" title="(in Python v3.13)"><span class="pre">str</span></a><span class="w"> </span><span class="p"><span class="pre">|</span></span><span class="w"> </span><a class="reference external" href="https://docs.python.org/3/library/constants.html#None" title="(in Python v3.13)"><span class="pre">None</span></a></span><span class="w"> </span><span class="o"><span class="pre">=</span></span><span class="w"> </span><span class="default_value"><span class="pre">None</span></span></em><span class="sig-paren">)</span> <span class="sig-return"><span class="sig-return-icon">&#x2192;</span> <span class="sig-return-typehint"><span class="pre">Iterable</span><span class="p"><span class="pre">[</span></span><a class="reference internal" href="#scrapy.Request" title="scrapy.Request"><span class="pre">Request</span></a><span class="p"><span class="pre">]</span></span></span></span><a class="reference internal" href="../_modules/scrapy/http/response/text.html#TextResponse.follow_all"><span class="viewcode-link"><span class="pre">[source]</span></span></a><a class="headerlink" href="#scrapy.http.TextResponse.follow_all" title="Link to this definition"></a></dt>
<dd><p>A generator that produces <a class="reference internal" href="#scrapy.Request" title="scrapy.Request"><code class="xref py py-class docutils literal notranslate"><span class="pre">Request</span></code></a> instances to follow all
links in <code class="docutils literal notranslate"><span class="pre">urls</span></code>. It accepts the same arguments as the <a class="reference internal" href="#scrapy.Request" title="scrapy.Request"><code class="xref py py-class docutils literal notranslate"><span class="pre">Request</span></code></a>’s
...
<span class="sig-name descname"><span class="pre">json</span></span><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="reference internal" href="../_modules/scrapy/http/response/text.html#TextResponse.json"><span class="viewcode-link"><span class="pre">[source]</span></span></a><a class="headerlink" href="#scrapy.http.TextResponse.json" title="Link to this definition"></a></dt>
<dd><div class="versionadded">
...
<span class="sig-name descname"><span class="pre">urljoin</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">url</span></span></em><span class="sig-paren">)</span><a class="reference internal" href="../_modules/scrapy/http/response/text.html#TextResponse.urljoin"><span class="viewcode-link"><span class="pre">[source]</span></span></a><a class="headerlink" href="#scrapy.http.TextResponse.urljoin" title="Link to this definition"></a></dt>
...
<code class="docutils literal notranslate"><span class="pre">&lt;base&gt;</span></code> tag, or just <a class="reference internal" href="#scrapy.http.Response.url" title="scrapy.http.Response.url"><code class="xref py py-attr docutils literal notranslate"><span class="pre">Response.url</span></code></a> if there is no such
tag.</p>
</dd></dl>
...
<h3>HtmlResponse objects<a class="headerlink" href="#htmlresponse-objects" title="Link to this heading"></a></h3>
<dl class="py class">
<dt class="sig sig-object py" id="scrapy.http.HtmlResponse">
<em class="property"><span class="pre">class</span><span class="w"> </span></em><span class="sig-prename descclassname"><span class="pre">scrapy.http.</span></span><span class="sig-name descname"><span class="pre">HtmlResponse</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">url</span></span></em><span class="optional">[</span>, <em class="sig-param"><span class="n"><span class="pre">...</span></span></em><span class="optional">]</span><span class="sig-paren">)</span><a class="reference internal" href="../_modules/scrapy/http/response/html.html#HtmlResponse"><span class="viewcode-link"><span class="pre">[source]</span></span></a><a class="headerlink" href="#scrapy.http.HtmlResponse" title="Link to this definition"></a></dt>
...
<h3>XmlResponse objects<a class="headerlink" href="#xmlresponse-objects" title="Link to this heading"></a></h3>
<dl class="py class">
<dt class="sig sig-object py" id="scrapy.http.XmlResponse">
<em class="property"><span class="pre">class</span><span class="w"> </span></em><span class="sig-prename descclassname"><span class="pre">scrapy.http.</span></span><span class="sig-name descname"><span class="pre">XmlResponse</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">url</span></span></em><span class="optional">[</span>, <em class="sig-param"><span class="n"><span class="pre">...</span></span></em><span class="optional">]</span><span class="sig-paren">)</span><a class="reference internal" href="../_modules/scrapy/http/response/xml.html#XmlResponse"><span class="viewcode-link"><span class="pre">[source]</span></span></a><a class="headerlink" href="#scrapy.http.XmlResponse" title="Link to this definition"></a></dt>
...
<h3>JsonResponse objects<a class="headerlink" href="#jsonresponse-objects" title="Link to this heading"></a></h3>
<dl class="py class">
<dt class="sig sig-object py" id="scrapy.http.JsonResponse">
<em class="property"><span class="pre">class</span><span class="w"> </span></em><span class="sig-prename descclassname"><span class="pre">scrapy.http.</span></span><span class="sig-name descname"><span class="pre">JsonResponse</span></span><span class="sig-paren">(</span><em class="sig-param"><span class="n"><span class="pre">url</span></span></em><span class="optional">[</span>, <em class="sig-param"><span class="n"><span class="pre">...</span></span></em><span class="optional">]</span><span class="sig-paren">)</span><a class="reference internal" href="../_modules/scrapy/http/response/json.html#JsonResponse"><span class="viewcode-link"><span class="pre">[source]</span></span></a><a class="headerlink" href="#scrapy.http.JsonResponse" title="Link to this definition"></a></dt>
...
header.</p>
        ...
        <a href="feed-exports.html" class="btn btn-neutral float-left" title="Feed exports" accesskey="p" rel="prev"><span class="fa fa-arrow-circle-left" aria-hidden="true"></span> Previous</a>
        <a href="link-extractors.html" class="btn btn-neutral float-right" title="Link Extractors" accesskey="n" rel="next">Next <span class="fa fa-arrow-circle-right" aria-hidden="true"></span></a>
    </div>
...
"""
url = "https://www.bbc.co.uk/learningenglish/sitemap.xml"
url_html = "https://docs.scrapy.org/en/latest/topics/request-response.html"
urls = parse_xml_sitemap(url_html, x_html)
print(urls)
...
# tree = sitemap_tree_for_homepage("https://www.bbc.co.uk/")
...
# parser = XMLSitemapParser(
#                 url="https://www.bbc.co.uk/sitemap.xml",
...
#                 recursion_level=1,
#                 web_client=None,  # RequestsWebClient()  None
#                 parent_urls=set(["https://www.bbc.co.uk/robots.txt"]),
#             )
# sitemap = parser.sitemap()

# # parser = xml.parsers.expat.ParserCreate(
# #     namespace_separator=parser._XMLSitemapParser__XML_NAMESPACE_SEPARATOR
# # )
# # parser.StartElementHandler = parser._xml_element_start
# # parser.EndElementHandler = parser._xml_element_end
# # parser.CharacterDataHandler = parser._xml_char_data

# # try:
# #     is_final = True
# #     parsed = parser.Parse(parser._content, is_final)
# #     import ipdb; ipdb.set_trace()
# # except Exception as e:
# #     print(e)

# print(sitemap.url)
# print(len(list(sitemap.all_pages())))
# print(len(list(sitemap.all_sitemaps())))

# print(list(sitemap.all_pages()))
# print(list(sitemap.all_sitemaps()))
# print(sitemap.to_dict())
