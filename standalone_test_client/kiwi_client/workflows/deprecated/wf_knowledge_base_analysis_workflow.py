...
workflow_graph_schema = {
  "nodes": {
    ...
    "load_documents": {
          ...
          "load_paths": [
              {
                  "filename_config": {
                      ...
                      "static_docname": "uploaded_file_1",
                  },
                  "output_field_name": "uploaded_file_1"
              },
              {
                  "filename_config": {
                      "input_namespace_field_pattern": UPLOADED_FILES_NAMESPACE_TEMPLATE, 
                      "input_namespace_field": "entity_username",
                      "static_docname": "uploaded_file_2",
                  },
                  "output_field_name": "uploaded_file_2"
              },
          ],
      ...
      # Writes: uploaded_file_1, uploaded_file_2 -> loaded_documents
    },
    ...
    "map_identifiers_to_process": { # Renamed from map_docs_to_extract
        ...
        # Reads: loaded_documents (from load_documents)
        # Iterates over the loaded documents.
        # Sends each item to construct_prompt
    },
  ...
  "edges": [
    ...
    { "src_node_id": "input_node", "dst_node_id": "load_documents", "mappings": [
      ...
      "description": "Pass the entity username to the load_documents node."
    },
...
async def main_test_extraction_workflow():
    ...
    setup_docs: List[SetupDocInfo] = [
        {
            'namespace': test_namespace, 'docname': "uploaded_file_1", 'is_versioned': False,
            'initial_data': {
                "source_filename": "uploaded_file_1",
        ...
        {
            'namespace': test_namespace, 'docname': "uploaded_file_2", 'is_versioned': False,
            'initial_data': {
                "source_filename": "uploaded_file_2",
    ...
    cleanup_docs: List[CleanupDocInfo] = [
        {'namespace': test_namespace, 'docname': "uploaded_file_1", 'is_versioned': False, 'is_shared': False},
        {'namespace': test_namespace, 'docname': "uploaded_file_2", 'is_versioned': False, 'is_shared': False},
    ]
    setup_schemas = None
