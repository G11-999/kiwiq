...
TOOLCALL_LLM_MODEL = "gpt-4.1"
DEFAULT_LLM_PROVIDER = "openai"
DEFAULT_LLM_MODEL = "gpt-4.1"

DRAFT_HITL_INPUT = {
      "title": "Blog Draft",
      "content": "![alt text](https://beta.kiwiq.ai/generated_903847.png)\n# Choosing Your First Bookkeeping Platform: Integration, Automation, and What Founders Wish They Knew\n\n## Introduction: Why Bookkeeping is the Founder’s Blind Spot — and the Secret to Startup Success\n\nIf you’re a founder or operations leader at a growing business, you already know: few things provoke more anxiety than startup bookkeeping. \n\n*“Bookkeeping 101 for startups—where do I start?”* *“Is there a checklist for founders?”* These are the questions that flood Reddit threads and founder forums, reflecting the reality that most founders feel **lost, overwhelmed, and too busy for accounting details**.\n\nYet, your bookkeeping setup isn’t just a back-office headache — it’s the foundation for investor confidence, compliance, fundraising, and capturing tax credits that could fund your next growth milestone. Choose wrong, and you risk endless spreadsheet tweaks, missed filings, and stressful transitions as you scale. Choose right, and bookkeeping becomes almost invisible: *automated, integrated, and future-proof*.\n\nThis guide is made for you — the ambitious, busy founder who wants: \n- **Jargon-free, plain-english checklists**\n- Step-by-step clarity, not accounting lectures.\n- Real pain points (and mistakes) shared openly.\n\nWe’ll break down **what to track**, **why monthly bookkeeping matters**, **how to compare platforms**, and most importantly, *how the best bookkeeping platform for startups* can eliminate fragmented workflows and unlock efficiency through integration and automation.\n\n---\n\n## Bookkeeping 101: What Founders Actually Need to Track (with Plain-Language Checklist)\n\nBefore you worry about integrations or automation, let’s get the basics right. Here’s what every founder actually needs to track — in plain English:\n\n### The Non-Negotiables\n- **Revenue:** All income, whether from services, products, or other sources.\n- **Expenses:** Every cost — payroll, tools, contractors, rent, software, marketing.\n- **Receipts & Supporting Docs:** Digital or paper, these prove your expense claims.\n- **Invoices Sent & Payments Received:** Who owes you? Who have you paid?\n- **Accounts Payable & Receivable (AP/AR):** What you owe and what’s owed to you.\n- **Payroll:** Salaries, contractor payments, taxes withheld.\n- **Bank/Credit Card Statements:** Reconcile these with your bookkeeping records monthly.\n- **Tax Obligations:** Sales tax, payroll tax, federal/state filings.\n- **Cash Runway:** How much cash you actually have, how fast you’re burning it.\n\n### Founder-Ready Startup Bookkeeping Checklist\n\n- [ ] Record all revenue as it comes in\n- [ ] Track and categorize every expense\n- [ ] Save receipts and documentation automatically\n- [ ] Issue and reconcile invoices monthly\n- [ ] Log all payments to vendors and contractors\n- [ ] Run and record payroll on a set schedule\n- [ ] Match (reconcile) every bank and credit card transaction\n- [ ] Track sales tax and payroll tax owed\n- [ ] Prepare monthly financial statements (Profit & Loss, Balance Sheet, Cash Flow)\n- [ ] Review cash position and runway monthly\n- [ ] Set calendar reminders for major tax deadlines\n- [ ] Audit books quarterly for missing data or errors\n\n\nFounders repeatedly ask, *“How do I set up my books with no accounting background?”* The answer: **start with a checklist, automate wherever possible, and never let your books fall a month behind**. Not only does this keep your business investor-ready, but it’s also *crucial* for maximizing tax credits. As Fondo’s Y Combinator profile stresses:\n\n> “Failing to file on time can mean missing out on up to $500k in tax credits.”\n\nIf this sounds daunting, well — it is, unless you pick a bookkeeping tool for founders that is designed for automation and simplicity.\n\n---\n\n## Why Consistency Matters: Monthly Bookkeeping, Compliance, and Avoiding Tax Headaches\n\nIt’s tempting to delay bookkeeping (“I’ll catch up before year end…”), but Reddit and YC alumni agree: **falling behind is a recipe for stress, mistakes, and lost money**.\n\n- *“What happens if I skip a month?”* Your expenses pile up. Receipts get lost. Categories are forgotten. By tax season, you’re scrambling.\n- *“Do I need monthly bookkeeping?”* Absolutely. \n\n### Compliance Isn’t Optional\n- **Regulatory filings** (like 1099s and quarterly taxes) require accurate, up-to-date records.\n- “Failing to file on time can mean missing out on up to $500k in tax credits.” [Y Combinator Fondo]\n\n### The True Cost of ‘Catch-Up’\n\n- Manual catch-up takes exponentially longer (and costs more if you hire a pro at the last minute).\n- You risk missing tax credits, misclassifying expenses, or triggering audits.\n\n### The Stress-Free Path?\n\nPlatforms like **TryFondo** let you automate transaction syncs, receipt uploads, and monthly report generation. As they say:\n\n> “Fondo is an all-in-one accounting platform for startups. We'll handle your bookkeeping, tax, and tax credits so you can focus on building your startup.”\n\nWhen your system is automated and monthly, you’re always investor-ready — you’ll never scramble to answer a due-diligence question again.\n\n---\n\n## How to Pick the Right Bookkeeping Platform: Avoiding Founder Pitfalls\n\nChoosing the best bookkeeping platform for startups isn’t about picking the tool with the most features — it’s about solving for **simplicity, integration, and real-world founder workflows**.\n\n### Stepwise Criteria for Founders\n\n1. **Simplicity & Usability:** \n   - Is onboarding quick? \n   - Can non-accountants use it confidently?\n2. **Integration:**\n   - Does it sync with your bank, payroll, CRM, and invoicing tools?\n   - Is there *one login, one dashboard* for all financial needs?\n3. **Automation:**\n   - Can it automate transaction imports, categorizations, and reporting?\n4. **Support & Compliance:**\n   - Live support? Proactive tax reminders? Automated compliance checks?\n5. **Customizable Reporting:**\n   - Can you generate tailored reports for investors or department leads with a few clicks?\n6. **All-In-One Scope:**\n   - Does it combine bookkeeping, tax filing, and tax credit maximization?\n7. **Transparent Pricing:**\n   - Clear, startup-friendly pricing with no hidden fees.\n\n### Real Founder Pain Points\n\n*“How do I integrate bookkeeping with my CRM and payroll systems?”*\n*“Which tool actually saves me time—no spreadsheet, no-code, just works?”*\n\nMany founders get trapped migrating between multiple platforms (QuickBooks for bookkeeping, another for payroll, a CRM for clients, Google Sheets for tracking) — resulting in double-entry, lost data, and **hours wasted reconciling**.\n\n### TryFondo vs QuickBooks vs Xero: Quick Comparison\n\n*“Fondo... is a pioneering firm known for its steadfast dedication to innovation and cutting-edge solutions.”* [BetterBuyer]\n\n\nDon’t just pick a bookkeeping app — pick an integrated business bookkeeping platform that’s built to scale with your needs.\n\n---\n\n## Integration & Automation: How to Connect Bookkeeping With Founder Workflows (and Why It Matters)\n\nHere’s where many startups get stuck: reconciling receipts, manually updating invoices, jumping between payroll, CRM, and banks…\n\n### A Day in the (Disjointed) Life\n\nYou close a client in your CRM, manually send them an invoice, mark it as paid, then update your spreadsheet. Next, you pay your team via a payroll tool but have to copy those figures into your bookkeeping app. \n\nBut what if your platform automated all of it?\n\n### What Seamless Integration Looks Like\n- **CRM and Invoicing  —** When you close a deal, an invoice is generated and sent automatically.\n- **Payments —** Confirmation of payment instantly reconciled and flagged in your dashboard.\n- **Payroll —** Team payments flow directly into your books, categorized by role or department.\n- **Bank Feeds —** Every bank/credit transaction automatically appears and is ready to categorize.\n\n*“Is there a way to automate data entry between tools?”* Yes: the best bookkeeping platforms for founders make integrations easy and enable real automation.\n\n#### TryFondo in Action\n> “Create customized financial reports effortlessly with our new Fondo Reporting feature.”\n\nTryFondo offers direct integrations with payroll, invoicing, and CRM systems so you never have to double-enter or reconcile data manually:\n- One login, one dashboard: manage your whole back office seamlessly.\n- Custom reports, on demand: for investors, managers, and board meetings.\n- Automated tax credit tracking and reporting—no more missed opportunities.\n\n#### Integration Setup Checklist\n\n- [ ] Connect your bank and credit accounts\n- [ ] Integrate your payroll provider (e.g., Gusto, Rippling)\n- [ ] Connect your CRM (e.g., Salesforce, HubSpot)\n- [ ] Activate automated invoice generation\n- [ ] Set up automated categorization rules\n- [ ] Enable scheduled financial reports\n- [ ] Set up user access and permissions for your team\n\nBy connecting your workflows, you’re not just saving time — you’re cutting out risk and staying investor-ready by default.\n\n---\n\n## Scaling Up: Why 'Founder-Friendly' Means Thinking Beyond Today — and Preventing Future Headaches\n\nMost founders choose a platform for today’s pain. But what happens as you hire, bring on more clients, or add new tools?\n\nReddit threads are filled with migration horror stories:\n*“I wish I had started with something that scaled; moving all my books was a nightmare.”*\n\n### Pitfalls of Fragmented Tools\n- **Visibility loss:** Tracking everything across spreadsheets and disconnected apps means you don’t have a true picture of spend, runway, and revenue.\n- **Migration Pain:** Transitioning years of data and retraining your team later can cost far more than starting with an all-in-one solution.\n- **Permissioning & Collaboration:** As you add staff, simple tools can break down—look for features like user roles, mobile access, and team sharing.\n\n### How TryFondo Scales With You\n- Inviting more users as your finance/ops team grows\n- Permissioning and audit trails for controls and compliance\n- Reporting customization as business complexity increases\n- Industry fit: Yes, TryFondo is built for agencies, consultancies, and staffing firms *as well as* direct founders\n\nSetting up the right platform now means you can *scale pain-free*, keep your books audit-ready, and never fear another messy migration.\n\n---\n\n## Founder FAQs: Real-World Objections, Mistakes, and Quick Wins\n\n#### 1. **Do I need a bookkeeper or accountant, or can I do it myself?**\n- Many founders start DIY, but outsourcing saves time and reduces risk as complexity grows. An all-in-one automated solution like TryFondo is often “just right” between pure DIY and traditional firm fees.\n\n#### 2. **How much does it cost to outsource bookkeeping?**\n- Startup-friendly platforms start around $200-$400/month. Always check for hidden fees with legacy firms or add-on charges (payroll, tax filings, etc.).\n\n#### 3. **What’s the best bookkeeping tool for founders with no accounting background?**\n- Look for platforms labelled as the *simplest bookkeeping software for founders*. TryFondo was built from founder feedback specifically for this audience.\n\n#### 4. **How do I keep my books investor-ready?**\n- Use monthly automation, customizable reporting, and consistent reconciliations. An all-in-one dashboard offers instant visibility.\n\n#### 5. **Can I integrate with payroll, CRM, and invoicing tools?**\n- Yes, but not all platforms do this without painful add-ons. TryFondo’s integrated business bookkeeping is a key differentiator.\n\n#### 6. **What about tax credits? Will I miss out if I DIY?**\n- Manual setup often overlooks eligible credits. “Failing to file on time can mean missing out on up to $500k in tax credits.” [YC/Fondo]\n\n#### 7. **Is there a startup bookkeeping checklist I can use?**\n- See our checklist above, or [download the founder-ready worksheet here](#) to stay on track.\n\n#### 8. **What happens if I fall behind on my books?**\n- The earlier you catch up, the less risk of penalties, missed credits, or painful catch-ups later. All-in-one tools with automation make catch-up easier.\n\n#### 9. **QuickBooks vs Xero vs TryFondo — which fits best?**\n- See our side-by-side table above, and consider: where do you want your workflow to live, and how much manual work are you willing to tolerate as your company grows?\n\n#### 10. **How can I automate monthly bookkeeping?**\n- Connect your bank, payroll, CRM, and invoicing; use a platform with built-in automation and rules for categorization.\n\n---\n\n## Ready to Simplify Your Books and Supercharge Your Startup’s Operations?\n\n**Book a demo with TryFondo today** or [download our founder-friendly bookkeeping checklist](#) to get started. Discover how one login and one dashboard can unlock your next phase of growth—while keeping your team focused on the work that matters most.\n\n> “The average Fondo customer gets back $21,000 each year.”\n\n---\n\n*Founders aren’t born loving bookkeeping. But with the right platform, it becomes an asset, not a burden.*\n"
    }
    ...
    "nodes": {
            ...
            "dynamic_output_schema": {
                "fields": {
                    ...
                    "draft_hitl_input": {
                        "type": "dict",
                        "required": False,
                        "default": DRAFT_HITL_INPUT,
                        "description": "Draft HITL input"
                    }
                }
            }
        },
        ...
        "route_content_approval": {
            ...
            "node_config": {
                ...
                "default_choice": "save_final_draft"
            }
        },
    ...
    "edges": [
        # Input -> State: Store initial values
        {
            ...
            "mappings": [
                ...
                {"src_field": "draft_hitl_input", "dst_field": "draft_hitl_input"}
            ]
        },
        ...
        # # Content Generation LLM -> HITL
        {
            ...
            "mappings": [
                {"src_field": "draft_hitl_input", "dst_field": "generated_content"}
            ]
        },
...
async def main_test_brief_to_blog():
    ...
    predefined_hitl_inputs = [
        ...
        #     "updated_content_draft": {
        #         "title": "Conversation Intelligence ROI Calculator: Quantifying the True Value of Automated Sales Insights for Enterprise Revenue Teams",
        #         "main_content": "# Conversatnue Teams\n\n## Executive Summary\n\n**The Bottom Line**: Conversation intelligence platforms deliver measurable ROI averaging 327-1,042% for enterprise revenue teams through three key value drivers:\n\n- **Time Savings**: $2.1M annually for a 500-person team through automated data entry and administrative task reduction\n- **Deal Velocity**: $3.2M in accelerated revenue recognition through 15% faster sales cycles  \n- **Revenue Lift**: $8.4M in incremental revenue from 10% win rate improvements via better coaching and execution\n\n**Typical Payback Period**: 1-3 months | **Implementation Investment**: $1-3M | **Net Annual Value**: $10-15M\n\n---\n\n*Revenue leaders, this one's for you.* You know conversation intelligence works—but proving its worth to the C-suite requires hard numbers. This comprehensive guide provides a structured methodology and downloadable calculator to build an ironclad business case for conversation intelligence implementation.\n\n## The Challenge: Quantifying Intangible Benefits\n\nRevenue leaders face mounting pressure to justify every technology investment with concrete ROI. When it comes to conversation intelligence platforms, the benefits are clear—better coaching, cleaner CRM data, faster deal cycles—but quantifying them can feel like catching smoke.\n\nThe solution? A systematic approach to measuring value across three critical dimensions.\n\n## Understanding the Full Value Spectrum of Conversation Intelligence\n\nConversation intelligence creates measurable value across multiple areas:\n\n### Time Savings: The Efficiency Multiplier\n- **Automated CRM data entry**: Saves 2-3 hours per rep per week\n- **Automated meeting summaries**: Reduces administrative overhead by 40%\n- **Real-time insights**: Eliminates manual call analysis and note-taking\n- **Streamlined coaching prep**: Managers spend 60% less time preparing for coaching sessions\n\n**Example Calculation**: A 50-person sales team saving 2.5 hours per week at $75/hour fully-loaded cost = $487,500 annual value\n\n### Deal Velocity: Accelerating Revenue Recognition\n- **Better visibility**: Deal progression insights accelerate sales cycles by 12-18%\n- **Early risk identification**: Prevents deal slippage through proactive intervention\n- **Improved follow-up**: Conversation insights drive more effective prospect engagement\n- **Faster onboarding**: New reps reach productivity 30% faster\n\n**Example Impact**: Reducing a 90-day sales cycle by 15% (13.5 days) on $50K average deals with 20 deals per month = $1.5M additional quarterly revenue recognition\n\n### Revenue Lift: The Coaching and Intelligence Advantage\n- **Enhanced coaching effectiveness**: Increases win rates by 7-15%\n- **Better customer intelligence**: Drives expansion opportunities and reduces churn\n- **Data-driven decision making**: Improves forecast accuracy by 25%\n- **Competitive intelligence**: Win rates improve 12% when competitive mentions are tracked\n\n## The ROI Calculator: Methodology and Approach\n\nOur calculator uses a comprehensive methodology that considers:\n\n### Input Variables\n1. **Team Composition**: Sales reps, managers, customer success team members\n2. **Deal Metrics**: Average deal size, sales cycle length, monthly deal volume, current win rates\n3. **Time Investment**: Current hours spent on administrative tasks, coaching prep, data entry\n4. **Cost Structure**: Fully-loaded employee costs including benefits and overhead\n5. **Platform Costs**: Subscription fees, implementation costs, training investment\n\n### Core Calculation Framework\n\n**Time Savings Value** = (Hours Saved × Fully-Loaded Hourly Rate × Team Size) × 52 weeks\n\n**Deal Velocity Value** = (Average Deal Size × Monthly Deal Volume × Velocity Improvement %) × (12 months / Original Cycle Length) × Time Value of Money Factor\n\n**Revenue Lift Value** = (Current Annual Revenue × Win Rate Improvement %) - (Platform Annual Cost)\n\n**Total ROI** = (Time Savings + Deal Velocity + Revenue Lift - Platform Costs) / Platform Costs × 100\n\n### Time Savings: Quantifying the Value of Automated Data Entry and Task Reduction\n\nThe most immediate and measurable benefit comes from automation:\n\n- **CRM Data Entry**: Average rep spends 2.1 hours/week on data entry\n- **Meeting Notes and Summaries**: 1.2 hours/week per rep\n- **Call Analysis and Coaching Prep**: 3.5 hours/week per manager\n- **Follow-up Task Creation**: 0.8 hours/week per rep\n\n**Formula**: Weekly Hours Saved × Fully-Loaded Hourly Cost × Team Size × 52 weeks\n\n**Example**: 25 reps saving 3.1 hours/week + 5 managers saving 3.5 hours/week at $85 average hourly cost = $425,100 annual value\n\n### Deal Velocity Improvements: Measuring the Impact on Sales Cycle Length\n\nConversation intelligence accelerates deals through:\n- **Better qualification**: Faster identification of qualified opportunities\n- **Proactive risk management**: Early intervention prevents stalled deals\n- **Improved follow-up**: Conversation insights drive more effective engagement\n- **Enhanced discovery**: Better questions lead to stronger value propositions\n\n**Industry Benchmarks**:\n- 12-18% average cycle time reduction\n- 20% improvement in deal progression visibility\n- 15% increase in qualified opportunity identification\n\n**Time Value Formula**: (Cycle Reduction Days / Original Cycle Days) × Annual Deal Value × Cost of Capital\n\n### Revenue Lift: Quantifying the Impact of Better Coaching and Deal Execution\n\nThe most significant long-term value comes from improved performance:\n\n**Coaching Effectiveness**:\n- Conversation intelligence provides objective coaching data\n- Win rates improve 7-15% with consistent coaching\n- Rep performance variance decreases by 25%\n- Time to productivity for new hires reduces by 30%\n\n**Deal Execution**:\n- Better discovery leads to stronger proposals\n- Competitive intelligence improves positioning\n- Customer insights drive expansion opportunities\n- Churn prediction enables proactive retention\n\n**Calculation**: (Current Annual Revenue × Performance Improvement %) - Platform Investment\n\n### Customer Success Impact: Calculating Reduced Churn and Expansion Revenue\n\nFor customer success teams, conversation intelligence delivers:\n- **Churn Reduction**: 15-25% improvement in retention through early warning signals\n- **Expansion Revenue**: 20% increase in upsell/cross-sell identification\n- **Customer Health Scoring**: Proactive intervention prevents account deterioration\n- **Onboarding Success**: New customer time-to-value improves by 30%\n\n**Customer Success ROI**: (Churn Reduction Value + Expansion Revenue Increase) - (Platform Allocation + Team Time Investment)\n\n## Putting It All Together: Your Total Conversation Intelligence ROI\n\nCombining all components into a comprehensive business case:\n\n### Sample Enterprise Calculation (500-person revenue team)\n\n**Time Savings**: $2.1M annually\n- 400 reps × 3 hours/week × $75/hour × 52 weeks = $2,340,000\n- Less 10% productivity adjustment = $2,106,000\n\n**Deal Velocity**: $3.2M additional revenue recognition\n- 15% cycle reduction on $120M annual bookings\n- Accelerated cash flow value = $3,200,000\n\n**Revenue Lift**: $8.4M incremental revenue\n- 10% win rate improvement on $84M annual pipeline\n- Net of platform costs = $8,400,000\n\n**Total Value**: $13.7M\n**Platform Investment**: $1.2M\n**Net ROI**: 1,042%\n**Payback Period**: 1.3 months\n\n### Presenting to Executives: Addressing Common Objections\n\n**\"The numbers seem too good to be true\"**\n- Provide conservative, realistic, and optimistic scenarios\n- Use industry benchmarks and peer references\n- Offer pilot program with limited scope\n\n**\"What about implementation risk?\"**\n- Phase rollout to minimize disruption\n- Provide detailed change management plan\n- Include training and adoption costs in calculations\n\n**\"How do we measure success?\"**\n- Establish baseline metrics before implementation\n- Create monthly tracking dashboard\n- Set up quarterly business reviews\n\n## Case Study: How TechFlow Achieved 327% ROI with Conversation Intelligence\n\nTechFlow, a 200-employee SaaS company, implemented conversation intelligence across their revenue team:\n\n**Challenge**: Manual CRM updates, inconsistent coaching, poor pipeline visibility\n\n**Implementation**: 6-month rollout across 75 revenue team members\n\n**Results after 12 months**:\n- **Time Savings**: $485,000 (2.8 hours/week per rep)\n- **Deal Velocity**: 22% faster sales cycles = $1.2M additional quarterly revenue\n- **Revenue Lift**: 12% win rate improvement = $2.8M additional bookings\n- **Total Value**: $4.485M\n- **Investment**: $375K (platform + implementation)\n- **ROI**: 1,096%\n\n**Key Success Factors**:\n1. Executive sponsorship and clear success metrics\n2. Gradual rollout with extensive training\n3. Integration with existing sales methodology\n4. Regular coaching and adoption reinforcement\n\n## Conclusion and Next Steps: Building Your Business Case\n\nConversation intelligence delivers measurable ROI across time savings, deal velocity, and revenue lift. The key is using a structured methodology that captures all value dimensions while accounting for implementation costs and risks.\n\n### Your Action Plan:\n\n1. **Download the Calculator**: Get our free ROI calculator with pre-built formulas\n2. **Gather Your Data**: Collect current metrics on team size, deal flow, and time allocation\n3. **Run the Numbers**: Calculate conservative, realistic, and optimistic scenarios\n4. **Build Your Presentation**: Create executive summary with key metrics and implementation plan\n5. **Address Objections**: Prepare responses to common concerns and risk mitigation strategies\n\n### Implementation Considerations:\n\n- **Change Management**: Plan for 6-8 weeks of adoption curve\n- **Training Investment**: Budget 2-3 hours per user for initial training\n- **Integration Complexity**: Factor in CRM and other tool integrations\n- **Success Metrics**: Establish baseline measurements before implementation\n\nThe data is clear: conversation intelligence delivers significant, measurable ROI for revenue teams. With the right approach to quantification and presentation, you can build a compelling business case that demonstrates clear value to your organization.\n\n*Ready to calculate your ROI? Download our free Conversation Intelligence ROI Calculator and start building your business case today. Include your team size and average deal metrics to get customized projections for your organization.*"
        #     }
        # }
    ]
