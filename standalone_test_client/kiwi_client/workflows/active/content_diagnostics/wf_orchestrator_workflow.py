...
3. AI Visibility Workflow - Provides AI visibility analysis
4. LinkedIn Scraping Workflow - Scrapes LinkedIn profile and posts (if execute_for_linkedin is True)
5. LinkedIn Content Analysis Workflow - Analyzes the scraped content for themes (if execute_for_linkedin is True)
...
AI_VISIBILITY_WORKFLOW_NAME = "ai_visibility_workflow"
LINKEDIN_SCRAPING_WORKFLOW_NAME = "linkedin_scraping_workflow"
LINKEDIN_ANALYSIS_WORKFLOW_NAME = "linkedin_content_analysis_workflow"
...
workflow_graph_schema = {
    "nodes": {
        ...
        "initial_router": {
            ...
            "node_config": {
                ...
                "choices_with_conditions": [
                    ...
                    {"choice_id": "run_blog_content_analysis", "input_path": "execute_for_company", "target_value": True},
                    # Conditionally route to LinkedIn workflows
                    {"choice_id": "linkedin_router", "input_path": "execute_for_linkedin", "target_value": True},
                    # Conditionally route to company workflows
                    {"choice_id": "company_router", "input_path": "execute_for_company", "target_value": True}
                ]
            }
        },
        ...
        # --- 5. AI Visibility Workflow ---
        "run_ai_visibility": {
            "node_id": "run_ai_visibility",
            "node_name": "workflow_runner",
            "node_config": {
                "workflow_name": AI_VISIBILITY_WORKFLOW_NAME,
                "execution_mode": "subprocess",
        ...
        # --- 10. Run Company Workflows (Placeholder) ---
        "run_company_workflows": {
                ...
                "mappings": [
                    {
                        ...
                        "destination_path": "company_processing.company_name"
                    },
                    {
                        "source_path": "company_url",
                        "destination_path": "company_processing.company_url"
                    }
                ]
            }
            # Note: Replace with actual workflow_runner nodes when company workflows are ready
        },
        ...
        "load_document_router": {
            ...
            "node_config": {
                ...
                "default_choice": None,
                "choices_with_conditions": [
                    {"choice_id": "load_linkedin_documents", "input_path": "execute_for_linkedin", "target_value": True},
                    {"choice_id": "load_company_documents", "input_path": "execute_for_company", "target_value": True}
                ]
            }
        },

        # --- Document Loading Nodes ---
        # Load LinkedIn-related documents
        "load_linkedin_documents": {
            ...
            "node_config": {
                "load_paths": [
                    ...
                    },
                    {
                        ...
                        "output_field_name": "linkedin_scraped_posts_doc"
                    },
                    {
                        "filename_config": {
                            "input_namespace_field_pattern": LINKEDIN_SCRAPED_PROFILE_NAMESPACE_TEMPLATE,
                        ...
                        "output_field_name": "linkedin_scraped_profile_raw_doc"
                    },
                    {
                        "filename_config": {
                            "input_namespace_field_pattern": LINKEDIN_SCRAPED_POSTS_NAMESPACE_TEMPLATE,
                        ...
                        "output_field_name": "linkedin_scraped_posts_raw_doc"
                    },
                    {
                        "filename_config": {
            ...
            "node_config": {
                "load_paths": [
                    ...
                    },
                    {
                        ...
                        "output_field_name": "classified_posts_doc",
                    },
                    {
                        "filename_config": {
                    ...
                    },
                    {
                        "filename_config": {
                            ...
                            "input_namespace_field": "company_name",
                            "static_docname": BLOG_COMPETITOR_AI_VISIBILITY_TEST_DOCNAME
                        },
                        "output_field_name": "competitor_ai_visibility_doc"
                    }
                ],
                "global_is_shared": False,
                "global_is_system_entity": False,
        ...
        "report_generation_router": {
            ...
            "node_config": {
                ...
                "default_choice": None,
                "choices_with_conditions": [
                    {"choice_id": "generate_executive_reports_router", "input_path": "execute_for_linkedin", "target_value": True},
                    {"choice_id": "generate_company_reports_router", "input_path": "execute_for_company", "target_value": True}
                ]
            }
        },
        ...
        "generate_executive_reports_router": {
            ...
            "node_config": {
                ...
                "default_choice": None,
                "choices_with_conditions": [
                    {"choice_id": "construct_executive_content_performance_prompt", "input_path": "execute_for_linkedin", "target_value": True},
                    {"choice_id": "construct_executive_industry_benchmarking_prompt", "input_path": "execute_for_linkedin", "target_value": True},
                    {"choice_id": "construct_personal_brand_opportunities_prompt", "input_path": "execute_for_linkedin", "target_value": True}
                ]
            }
        },
        ...
        "generate_company_reports_router": {
            ...
            "node_config": {
                ...
                "default_choice": None,
                "choices_with_conditions": [
                    {"choice_id": "construct_blog_performance_health_prompt", "input_path": "execute_for_company", "target_value": True},
                    {"choice_id": "construct_content_quality_structure_prompt", "input_path": "execute_for_company", "target_value": True},
                    {"choice_id": "construct_competitive_intelligence_prompt", "input_path": "execute_for_company", "target_value": True},
                    {"choice_id": "construct_content_gap_analysis_prompt", "input_path": "execute_for_company", "target_value": True},
                    {"choice_id": "construct_strategic_opportunities_prompt", "input_path": "execute_for_company", "target_value": True}
                ]
            }
        },
            ...
            "node_config": {
                "prompt_templates": {
                    "user_prompt": {
                        ...
                        "variables": {
                            "deep_research_data": None,
                            "all_reports_summary": None
                        },
                        "construct_options": {
                            "deep_research_data": "deep_research_data",
                            "all_reports_summary": "all_reports_summary"
                        }
                    },
                    "system_prompt": {
                        "id": "system_prompt",
        ...
        "generate_business_impact_projection": {
            ...
            "node_config": {
                ...
                "system_prompt": "You are an expert at business impact analysis and ROI projection.",
                "user_prompt_template": BUSINESS_IMPACT_PROJECTION_PROMPT,
    ...
    "edges": [
        # Store essential data in graph state
        {
            ...
            "mappings": [
                ...
                {"src_field": "execute_for_linkedin", "dst_field": "execute_for_linkedin"},
                {"src_field": "execute_for_company", "dst_field": "execute_for_company"},
        ...
        # Pass required inputs to Deep Research
        {
            ...
            "mappings": [
                {"src_field": "company_name", "dst_field": "company_name"},
                {"src_field": "entity_username", "dst_field": "entity_username"},
                {"src_field": "execute_for_company", "dst_field": "run_content_strategy"},
                {"src_field": "execute_for_linkedin", "dst_field": "run_linkedin_research"}
            ]
        },

        # Input -> AI Visibility (control flow)
        {
            "src_node_id": "input_node",
            "dst_node_id": "run_ai_visibility",
            "mappings": []
        },

        # Pass required inputs to AI Visibility
                {
            "src_node_id": "$graph_state",
            "dst_node_id": "run_ai_visibility",
            "mappings": [
                {"src_field": "company_name", "dst_field": "company_name"},
                {"src_field": "entity_username", "dst_field": "entity_username"},
                {"src_field": "execute_for_linkedin", "dst_field": "run_linkedin_exec"},
                {"src_field": "execute_for_company", "dst_field": "run_blog_analysis"}
            ]
        },
        ...
        {
            "src_node_id": "run_ai_visibility",
            "dst_node_id": "$graph_state",
            "mappings": [
                {"src_field": "workflow_outputs", "dst_field": "ai_visibility_result"}
            ]
        },
        {
            "src_node_id": "run_linkedin_scraping",
        ...
        },
        {
            ...
            "mappings": [
                ...
                {"src_field": "competitor_ai_visibility_doc", "dst_field": "competitor_ai_visibility_doc"}
            ]
        },
        ...
        },
        {
            ...
            "dst_node_id": "$graph_state",
            "mappings": [
                {"src_field": "llm_output", "dst_field": "executive_content_performance"}
            ]
        },
        ...
        },
        {
            ...
            "mappings": [
                {"src_field": "linkedin_content_doc", "dst_field": "linkedin_content_data"},
                {"src_field": "competitor_docs", "dst_field": "competitor_data"}
            ]
        },
        {
        ...
        
        {
            ...
            "dst_node_id": "$graph_state",
            "mappings": [
                {"src_field": "llm_output", "dst_field": "executive_industry_benchmarking"}
            ]
        },
        ...
        },
        {
            ...
            "mappings": [
                {"src_field": "linkedin_content_doc", "dst_field": "linkedin_content_data"},
                {"src_field": "ai_visibility_docs", "dst_field": "ai_visibility_data"}
            ]
        },
        {
        ...
        # Personal Brand Opportunities Report
        {
            ...
            "dst_node_id": "$graph_state",
            "mappings": [
                {"src_field": "llm_output", "dst_field": "personal_brand_opportunities"}
            ]
        },
        ...
        },
        {
            ...
            "dst_node_id": "generate_executive_action_plan",
            "mappings": [
                {"src_field": "ai_visibility_docs", "dst_field": "visibility_scorecard"},
                ...
                {"src_field": "ai_visibility_docs", "dst_field": "ai_recognition"},
        ...
        
        {
            ...
            "dst_node_id": "$graph_state",
            "mappings": [
                {"src_field": "llm_output", "dst_field": "executive_action_plan"}
            ]
        },
        ...
        },
        {
            ...
            "dst_node_id": "aggregate_executive_reports",
            "mappings": [
                {"src_field": "ai_visibility_docs", "dst_field": "executive_visibility_scorecard"},
                ...
                {"src_field": "ai_visibility_docs", "dst_field": "executive_ai_recognition"},
        ...
        },
        {
            ...
            "dst_node_id": "construct_competitive_intelligence_prompt",
            "mappings": [
                {"src_field": "__literal__:{}", "dst_field": "competitor_data"},
                {"src_field": "ai_visibility_docs", "dst_field": "ai_visibility_data"}
            ]
        },
        {
        ...
        },
        {
            ...
            "mappings": [
                {"src_field": "deep_research_doc", "dst_field": "deep_research_data"},
                {"src_field": "__literal__:{}", "dst_field": "all_reports_summary"}
            ]
        },
        {
        ...
        # Store company report outputs in state
        {
            ...
            "dst_node_id": "$graph_state",
            "mappings": [
                {"src_field": "llm_output", "dst_field": "blog_performance_health"}
            ]
        },
        {
            ...
            "dst_node_id": "$graph_state",
            "mappings": [
                {"src_field": "llm_output", "dst_field": "content_quality_structure"}
            ]
        },
        {
            ...
            "dst_node_id": "$graph_state",
            "mappings": [
                {"src_field": "llm_output", "dst_field": "competitive_intelligence"}
            ]
        },
        {
            ...
            "dst_node_id": "$graph_state",
            "mappings": [
                {"src_field": "llm_output", "dst_field": "content_gap_analysis"}
            ]
        },
        {
            ...
            "dst_node_id": "$graph_state",
            "mappings": [
                {"src_field": "llm_output", "dst_field": "strategic_opportunities"}
            ]
        },
        ...
        },
        {
            ...
            "mappings": [
                {"src_field": "ai_visibility_docs", "dst_field": "ai_visibility_overview"},
                {"src_field": "blog_performance_health", "dst_field": "blog_performance"},
                {"src_field": "blog_content_doc", "dst_field": "technical_seo"},
        ...
        },
        {
            ...
            "dst_node_id": "$graph_state",
            "mappings": [
                {"src_field": "llm_output", "dst_field": "company_action_plan"}
            ]
        },
        ...
        },
        {
            ...
            "dst_node_id": "aggregate_company_reports",
            "mappings": [
                {"src_field": "ai_visibility_docs", "dst_field": "company_ai_visibility_overview"},
                {"src_field": "blog_performance_health", "dst_field": "blog_performance_health"},
                {"src_field": "blog_content_doc", "dst_field": "technical_seo_foundation"},
    ...
    "metadata": {
        "$graph_state": {
            "reducer": {
                ...
                "ai_visibility_docs": "replace",
                "deep_research_doc": "replace",
                "competitor_docs": "replace",
                ...
                "competitor_ai_visibility_doc": "replace"
            }
        }
    },
...
async def validate_orchestrator_output(outputs: Optional[Dict[str, Any]], test_inputs: Dict[str, Any]) -> bool:
    ...
    if test_inputs['execute_for_linkedin']:
    ...
    if test_inputs['execute_for_company']:
...
async def main_test_orchestrator():
    ...
    # --- Test Inputs ---
    TEST_INPUTS = {
        "entity_username": "joyeedesigner",  # LinkedIn username
        "company_name": "TestCompany",  # Company name for analysis
        "execute_for_linkedin": True,  # Execute LinkedIn workflows
        "execute_for_company": False,  # Skip company workflows for now
        "linkedin_profile_url": "https://www.linkedin.com/in/joyeedesigner/",  # LinkedIn URL
        "company_url": "https://testcompany.com",  # Company website URL (optional)
        "blog_start_urls": ["https://example.com/blog"] # Example blog start URL
    }
