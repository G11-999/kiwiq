...
async def main_test_linkedin_analysis():
    ...
    test_scraping_namespace = LINKEDIN_SCRAPED_POSTS_NAMESPACE_TEMPLATE.format(item=entity_username)
    ...
    setup_docs: List[SetupDocInfo] = [
        {
            'namespace': test_scraping_namespace, 'docname': LINKEDIN_SCRAPED_POSTS_DOCNAME, 'is_versioned': False,
    ...
    test_analysis_namespace = LINKEDIN_CONTENT_ANALYSIS_NAMESPACE_TEMPLATE.format(item=entity_username)
    cleanup_docs: List[CleanupDocInfo] = [
        ...
        {'namespace': test_analysis_namespace, 
         'docname': LINKEDIN_CONTENT_ANALYSIS_DOCNAME, 
         'is_versioned': False, 
         'is_shared': False},
    ]
