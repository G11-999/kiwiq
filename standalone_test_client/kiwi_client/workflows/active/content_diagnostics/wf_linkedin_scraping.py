...
async def main_test_linkedin_scraping():
    ...
    profile_cleanup_doc: CleanupDocInfo = {
        'namespace': LINKEDIN_SCRAPED_PROFILE_NAMESPACE_TEMPLATE,
        'docname': LINKEDIN_SCRAPED_PROFILE_DOCNAME, # Docname pattern from the workflow
    ...
    posts_cleanup_doc: CleanupDocInfo = {
        'namespace': LINKEDIN_SCRAPED_POSTS_NAMESPACE_TEMPLATE,
        'docname': LINKEDIN_SCRAPED_POSTS_DOCNAME, # Docname pattern from the workflow
        'is_shared': False, # Matches store_raw_data node config
        'is_versioned': False, # Matches store_raw_data node config
        'is_system_entity': False
    }
