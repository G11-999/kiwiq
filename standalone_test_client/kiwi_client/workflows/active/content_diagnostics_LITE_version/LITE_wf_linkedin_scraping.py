...
from kiwi_client.workflows.active.document_models.customer_docs import (
    ...
    LITE_LINKEDIN_SCRAPED_PROFILE_RAW_DOCNAME,
    LITE_LINKEDIN_SCRAPED_POSTS_RAW_DOCNAME,
)
          ...
          # Config 1: Store Raw Profile
          {
            ...
            "target_path": {
              "filename_config": {
                            ...
                            "static_docname": LITE_LINKEDIN_SCRAPED_PROFILE_RAW_DOCNAME,
              }
            }
          },
          # Config 2: Store Raw Posts
          {
            ...
            "target_path": {
              "filename_config": {
                            ...
                            "input_namespace_field": "entity_username",
                            "static_docname": LITE_LINKEDIN_SCRAPED_POSTS_RAW_DOCNAME,
              }
            }
          }
        ]
...
async def main_test_linkedin_scraping():
    ...
    profile_cleanup_doc: CleanupDocInfo = {
                    'namespace': LITE_LINKEDIN_SCRAPED_PROFILE_NAMESPACE_TEMPLATE,
            'docname': LITE_LINKEDIN_SCRAPED_PROFILE_DOCNAME, # Docname pattern from the workflow
    ...
    posts_cleanup_doc: CleanupDocInfo = {
                    'namespace': LITE_LINKEDIN_SCRAPED_POSTS_NAMESPACE_TEMPLATE,
            'docname': LITE_LINKEDIN_SCRAPED_POSTS_DOCNAME, # Docname pattern from the workflow
        'is_shared': False, # Matches store_raw_data node config
        'is_versioned': False, # Matches store_raw_data node config
        'is_system_entity': False
    }
