...
async def main_test_content_calendar_workflow():
    ...
    setup_docs: List[SetupDocInfo] = [
        ...
        # User Preferences Document
        {
            ...
            'initial_data': {
      "created_at": "2025-06-06T18:37:06.824000",
      "updated_at": "2025-06-06T18:37:06.829000",
      "goals_answers": [
          {
            "question": "Establish Thought Leadership",
            "answer": "Position as thoughtful AI investor who cuts through hype and provides valuable guidance to founders seeking investment"
          },
          {
            "question": "Build Personal Brand",
            "answer": "Build personal brand through consistent, thoughtful posting while evangelizing Bee Partners without explicit promotion"
          },
          {
            "question": "Quality Audience Engagement",
            "answer": "Create scalable discoverability beyond in-person meetings and engage with technical professionals considering entrepreneurship"
          },
          {
            "question": "Generate Quality Deal Flow",
            "answer": "Meet founders building in AI/tech domains and generate investment opportunities from followers"
          }
        ],
    "user_preferences": {
        "audience": {
          "segments": [
            {
              "audience_type": "Potential Founders",
              "description": "Technical professionals considering entrepreneurship, engineers and product managers exploring startup ideas, employed talent contemplating the leap to founding"
            },
            {
              "audience_type": "Early-Stage Founders",
              "description": "Pre-seed and seed stage entrepreneurs, technical founders navigating commercialization, first-time founders seeking investor perspective"
            },
            {
              "audience_type": "Investor Community",
              "description": "Fellow investors in deep tech/AI, potential co-investors and partners, ecosystem builders in VC"
            }
          ]
        },
        "posting_schedule": {
